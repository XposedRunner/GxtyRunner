...
//                linearLayout.addView(linearLayout1, layoutParams);
    ...
    public static EditTextDialog show(FragmentManager manager, long tag) {
        EditTextDialog scheduleDialog = new EditTextDialog();
        scheduleDialog.show(manager, String.valueOf(tag));
        return scheduleDialog;
    }

    public static EditTextDialog show(FragmentManager manager, long tag, OnActionListener actionListener) {
        EditTextDialog scheduleDialog = new EditTextDialog();
        scheduleDialog.show(manager, String.valueOf(tag));
