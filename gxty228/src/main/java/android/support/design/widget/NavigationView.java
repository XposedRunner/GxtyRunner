    ...
    protected void onMeasure(int i, int i2) {
        switch (MeasureSpec.getMode(i)) {
            case Integer.MIN_VALUE:
                i = MeasureSpec.makeMeasureSpec(Math.min(MeasureSpec.getSize(i), this.mMaxWidth), MemoryConstants.GB);
                break;
            case 0:
                i = MeasureSpec.makeMeasureSpec(this.mMaxWidth, MemoryConstants.GB);
                break;
        }
