...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        protected void onMeasure(int i, int i2) {
            ...
            if (MeasureSpec.getMode(i) == MemoryConstants.GB && TabLayout.this.mMode == 1 && TabLayout.this.mTabGravity == 1) {
                int childCount = getChildCount();
                int i3 = 0;
                int i4 = 0;
                while (i3 < childCount) {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        switch (MeasureSpec.getMode(i2)) {
            case Integer.MIN_VALUE:
                i2 = MeasureSpec.makeMeasureSpec(Math.min(dpToPx, MeasureSpec.getSize(i2)), MemoryConstants.GB);
                break;
            case 0:
                i2 = MeasureSpec.makeMeasureSpec(dpToPx, MemoryConstants.GB);
                break;
        }
        ...
        if (getChildCount() == 1) {
            ...
            if (dpToPx != 0) {
                childAt.measure(MeasureSpec.makeMeasureSpec(getMeasuredWidth(), MemoryConstants.GB), getChildMeasureSpec(i2, getPaddingTop() + getPaddingBottom(), childAt.getLayoutParams().height));
            }
        }
    }
