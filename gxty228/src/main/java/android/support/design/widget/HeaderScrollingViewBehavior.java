    ...
    public boolean onMeasureChild(CoordinatorLayout coordinatorLayout, View view, int i, int i2, int i3, int i4) {
        ...
        if (i5 == -1 || i5 == -2) {
            ...
            if (findFirstDependency != null) {
                ...
                coordinatorLayout.onMeasureChild(view, i, i2, MeasureSpec.makeMeasureSpec(getScrollRange(findFirstDependency) + (size - findFirstDependency.getMeasuredHeight()), i5 == -1 ? MemoryConstants.GB : Integer.MIN_VALUE), i4);
                return true;
            }
        }
        return false;
