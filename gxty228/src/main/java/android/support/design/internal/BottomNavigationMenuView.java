...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        int makeMeasureSpec = MeasureSpec.makeMeasureSpec(this.mItemHeight, MemoryConstants.GB);
        int min2;
        ...
        for (min = 0; min < childCount; min++) {
            ...
            if (childAt.getVisibility() != 8) {
                childAt.measure(MeasureSpec.makeMeasureSpec(this.mTempChildWidths[min], MemoryConstants.GB), makeMeasureSpec);
                childAt.getLayoutParams().width = childAt.getMeasuredWidth();
                i3 += childAt.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(i3, MeasureSpec.makeMeasureSpec(i3, MemoryConstants.GB), 0), View.resolveSizeAndState(this.mItemHeight, makeMeasureSpec, 0));
    }
