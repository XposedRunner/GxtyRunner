    ...
    protected void createAnimators(ViewGroup viewGroup, TransitionValuesMaps transitionValuesMaps, TransitionValuesMaps transitionValuesMaps2, ArrayList<TransitionValues> arrayList, ArrayList<TransitionValues> arrayList2) {
                        ...
                        if (transitionValues2 != null) {
                            ...
                            if (view2 == null || transitionProperties == null || transitionProperties.length <= 0) {
                                ...
                                if (transitionValues3 != null) {
                                    for (i2 = 0; i2 < transitionProperties.length; i2++) {
                                        transitionValues6.values.put(transitionProperties[i2], transitionValues3.values.get(transitionProperties[i2]));
                                    }
                                }
        ...
        if (j != 0) {
            for (i2 = 0; i2 < sparseIntArray.size(); i2++) {
                Animator animator3 = (Animator) this.mAnimators.get(sparseIntArray.keyAt(i2));
