...
class TypefaceCompatApi21Impl extends TypefaceCompatBaseImpl {
    ...
    L_0x0006:
        ...
        r1 = r1.getUri();	 Catch:{ IOException -> 0x0056 }
        r3 = "r";
        r3 = r2.openFileDescriptor(r1, r3, r9);	 Catch:{ IOException -> 0x0056 }
        r2 = 0;
        r1 = r7.getFile(r3);	 Catch:{ Throwable -> 0x0048, all -> 0x005c }
    ...
    L_0x0025:
        ...
        r5 = 0;
        r1 = super.createFromInputStream(r8, r4);	 Catch:{ Throwable -> 0x0068, all -> 0x009c }
