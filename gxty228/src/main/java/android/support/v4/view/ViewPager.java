...
public class ViewPager extends ViewGroup {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.mChildWidthMeasureSpec = MeasureSpec.makeMeasureSpec(paddingLeft, MemoryConstants.GB);
        this.mChildHeightMeasureSpec = MeasureSpec.makeMeasureSpec(measuredHeight, MemoryConstants.GB);
        this.mInLayout = true;
        populate();
        ...
        for (i5 = 0; i5 < i3; i5++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (layoutParams == null || !layoutParams.isDecor) {
                    childAt2.measure(MeasureSpec.makeMeasureSpec((int) (layoutParams.widthFactor * ((float) paddingLeft)), MemoryConstants.GB), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
                ...
                if (!layoutParams.isDecor) {
                    ...
                    if (infoForChild != null) {
                        ...
                        if (layoutParams.needsMeasure) {
                            ...
                            childAt2.measure(MeasureSpec.makeMeasureSpec((int) (layoutParams.widthFactor * ((float) max)), MemoryConstants.GB), MeasureSpec.makeMeasureSpec((i6 - paddingTop) - paddingBottom, MemoryConstants.GB));
                        }
