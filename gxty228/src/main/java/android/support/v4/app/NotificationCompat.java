...
public class NotificationCompat {
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            if (VERSION.SDK_INT >= 24) {
                ...
                for (Message message : this.mMessages) {
                    Message message2;
                    arrayList.add(message2.getText());
                    arrayList2.add(Long.valueOf(message2.getTimestamp()));
                    arrayList3.add(message2.getSender());
                    arrayList4.add(message2.getDataMimeType());
                    arrayList5.add(message2.getDataUri());
                }
            ...
            message2 = findLatestIncomingMessage();
            if (this.mConversationTitle != null) {
                notificationBuilderWithBuilderAccessor.getBuilder().setContentTitle(this.mConversationTitle);
            } else if (message2 != null) {
                notificationBuilderWithBuilderAccessor.getBuilder().setContentTitle(message2.getSender());
            }
            if (message2 != null) {
                android.app.Notification.Builder builder = notificationBuilderWithBuilderAccessor.getBuilder();
                if (this.mConversationTitle != null) {
                    makeMessageLine = makeMessageLine(message2);
                } else {
                    makeMessageLine = message2.getText();
                }
            ...
            if (VERSION.SDK_INT >= 16) {
                ...
                for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                    ...
                    makeMessageLine = z ? makeMessageLine(message2) : message2.getText();
        ...
        private CharSequence makeMessageLine(Message message) {
            ...
            int i2 = obj != null ? ViewCompat.MEASURED_STATE_MASK : -1;
