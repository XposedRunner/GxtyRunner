...
public class AudioAttributesCompat {
    ...
    public String toString() {
        ...
        if (unwrap() != null) {
            ...
            if (this.mLegacyStream != null) {
                stringBuilder.append(" stream=").append(this.mLegacyStream);
                stringBuilder.append(" derived");
            }
            stringBuilder.append(" usage=").append(usageToString()).append(" content=").append(this.mContentType).append(" flags=0x").append(Integer.toHexString(this.mFlags).toUpperCase());
        }
