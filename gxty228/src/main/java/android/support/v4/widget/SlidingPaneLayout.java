        ...
        while (i5 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    ...
                    mode = MeasureSpec.makeMeasureSpec(paddingLeft - mode, MemoryConstants.GB);
                } else {
                    mode = MeasureSpec.makeMeasureSpec(layoutParams.width, MemoryConstants.GB);
                }
                if (layoutParams.height == -2) {
                    i8 = MeasureSpec.makeMeasureSpec(mode2, Integer.MIN_VALUE);
                } else if (layoutParams.height == -1) {
                    i8 = MeasureSpec.makeMeasureSpec(mode2, MemoryConstants.GB);
                } else {
                    i8 = MeasureSpec.makeMeasureSpec(layoutParams.height, MemoryConstants.GB);
                }
                ...
                if (childAt2.getVisibility() != 8) {
                    ...
                    if (childAt2.getVisibility() != 8) {
                        ...
                        if (!z || childAt2 == this.mSlideableView) {
                            if (layoutParams.weight > 0.0f) {
                                if (layoutParams.width != 0) {
                                    mode = MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), MemoryConstants.GB);
                                } else if (layoutParams.height == -2) {
                                    mode = MeasureSpec.makeMeasureSpec(mode2, Integer.MIN_VALUE);
                                } else if (layoutParams.height == -1) {
                                    mode = MeasureSpec.makeMeasureSpec(mode2, MemoryConstants.GB);
                                } else {
                                    mode = MeasureSpec.makeMeasureSpec(layoutParams.height, MemoryConstants.GB);
                                }
                                if (z) {
                                    size2 = paddingLeft - (layoutParams.rightMargin + layoutParams.leftMargin);
                                    i5 = MeasureSpec.makeMeasureSpec(size2, MemoryConstants.GB);
                                    if (i8 != size2) {
                                        childAt2.measure(i5, mode);
                                    }
                                } else {
                                    childAt2.measure(MeasureSpec.makeMeasureSpec(((int) ((layoutParams.weight * ((float) Math.max(0, i6))) / f)) + i8, MemoryConstants.GB), mode);
                                }
                            }
                        } else if (layoutParams.width < 0 && (i8 > i9 || layoutParams.weight > 0.0f)) {
                            if (obj == null) {
                                size2 = MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), MemoryConstants.GB);
                            } else if (layoutParams.height == -2) {
                                size2 = MeasureSpec.makeMeasureSpec(mode2, Integer.MIN_VALUE);
                            } else if (layoutParams.height == -1) {
                                size2 = MeasureSpec.makeMeasureSpec(mode2, MemoryConstants.GB);
                            } else {
                                size2 = MeasureSpec.makeMeasureSpec(layoutParams.height, MemoryConstants.GB);
                            }
                            childAt2.measure(MeasureSpec.makeMeasureSpec(i9, MemoryConstants.GB), size2);
                        }
                    }
                }
            }
