...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                ...
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((((int) (((float) (i - SwipeRefreshLayout.this.mFrom)) * f)) + SwipeRefreshLayout.this.mFrom) - SwipeRefreshLayout.this.mCircleView.getTop());
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mTarget != null) {
            this.mTarget.measure(MeasureSpec.makeMeasureSpec((getMeasuredWidth() - getPaddingLeft()) - getPaddingRight(), MemoryConstants.GB), MeasureSpec.makeMeasureSpec((getMeasuredHeight() - getPaddingTop()) - getPaddingBottom(), MemoryConstants.GB));
            this.mCircleView.measure(MeasureSpec.makeMeasureSpec(this.mCircleDiameter, MemoryConstants.GB), MeasureSpec.makeMeasureSpec(this.mCircleDiameter, MemoryConstants.GB));
            this.mCircleViewIndex = -1;
    ...
    private void moveSpinner(float f) {
        ...
        this.mProgress.setProgressRotation(((-0.25f + (max * 0.4f)) + (abs * DECELERATE_INTERPOLATION_FACTOR)) * 0.5f);
        setTargetOffsetTopAndBottom(i - this.mCurrentTargetOffsetTop);
    }
