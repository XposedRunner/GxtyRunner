...
public final class MimeTypeFilter {
    ...
    public static boolean matches(@Nullable String str, @NonNull String str2) {
        ...
        return mimeTypeAgainstFilter(str.split(HttpUtils.PATHS_SEPARATOR), str2.split(HttpUtils.PATHS_SEPARATOR));
    }
    ...
    public static String matches(@Nullable String str, @NonNull String[] strArr) {
        ...
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(split, str2.split(HttpUtils.PATHS_SEPARATOR))) {
                return str2;
            }
        }
        return null;
    ...
    public static String matches(@Nullable String[] strArr, @NonNull String str) {
        ...
        String[] split = str.split(HttpUtils.PATHS_SEPARATOR);
        for (String str2 : strArr) {
            if (mimeTypeAgainstFilter(str2.split(HttpUtils.PATHS_SEPARATOR), split)) {
                return str2;
            }
        }
        return null;
