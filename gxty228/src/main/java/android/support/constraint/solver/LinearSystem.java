...
public class LinearSystem {
    ...
    void displaySystemInformations() {
        ...
        System.out.println("Linear System -> Table size: " + this.TABLE_SIZE + " (" + getDisplaySize(this.TABLE_SIZE * this.TABLE_SIZE) + ") -- row sizes: " + getDisplaySize(i2) + ", actual size: " + getDisplaySize(i3) + " rows: " + this.mNumRows + HttpUtils.PATHS_SEPARATOR + this.mMaxRows + " cols: " + this.mNumColumns + HttpUtils.PATHS_SEPARATOR + this.mMaxColumns + " " + 0 + " occupied cells, " + getDisplaySize(0));
    }
