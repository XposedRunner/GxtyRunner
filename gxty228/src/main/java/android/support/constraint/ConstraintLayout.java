...
public class ConstraintLayout extends ViewGroup {
                ...
                if (constraintWidget instanceof Guideline) {
                    ...
                    if (view == null) {
                        ...
                        if (layoutParams.width == -2) {
                            ...
                            childMeasureSpec = MeasureSpec.makeMeasureSpec(constraintWidget.getWidth(), MemoryConstants.GB);
                        }
                        if (layoutParams.height == -2) {
                            childMeasureSpec2 = getChildMeasureSpec(i2, paddingBottom, layoutParams.height);
                        } else {
                            childMeasureSpec2 = MeasureSpec.makeMeasureSpec(constraintWidget.getHeight(), MemoryConstants.GB);
                        }
                        ...
                        if (childMeasureSpec != constraintWidget.getWidth()) {
                            ...
                            if (obj2 != null && constraintWidget.getRight() > this.mLayoutWidget.getWidth()) {
                                this.mLayoutWidget.setWidth(constraintWidget.getRight());
                            }
                            obj4 = 1;
                        } else {
                            obj4 = obj;
                        ...
                        if (childMeasureSpec2 != constraintWidget.getHeight()) {
                            ...
                            if (obj3 != null && constraintWidget.getBottom() > this.mLayoutWidget.getHeight()) {
                                this.mLayoutWidget.setHeight(constraintWidget.getBottom());
                            }
                            obj4 = 1;
                        }
                        if (layoutParams.needsBaseline) {
    ...
    private void setSelfDimensionBehaviour(int i, int i2) {
        ...
        this.mLayoutWidget.setMinWidth(this.mMinWidth);
        this.mLayoutWidget.setMinHeight(this.mMinHeight);
