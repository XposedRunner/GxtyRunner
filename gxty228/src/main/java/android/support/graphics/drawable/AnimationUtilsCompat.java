...
public class AnimationUtilsCompat {
    public static Interpolator loadInterpolator(Context context, int i) throws NotFoundException {
        ...
        if (i == AndroidResources.FAST_OUT_LINEAR_IN) {
            ...
            xmlResourceParser.close();
            return fastOutLinearInInterpolator;
        } else if (i == AndroidResources.LINEAR_OUT_SLOW_IN) {
            ...
            fastOutLinearInInterpolator = createInterpolatorFromXml(context, context.getResources(), context.getTheme(), xmlResourceParser);
            if (xmlResourceParser == null) {
                return fastOutLinearInInterpolator;
            }
            xmlResourceParser.close();
