        ...
        while (true) {
            ...
            if (next != 3 && next != 1) {
                ...
                if (xmlPullParser.getName().equals("keyframe")) {
                    ...
                    loadKeyframe = loadKeyframe(context, resources, theme, Xml.asAttributeSet(xmlPullParser), i4, xmlPullParser);
                    ...
                    for (i3 = 0; i3 < i2; i3++) {
                        ...
                        if (keyframe.getFraction() >= 0.0f) {
                            if (i3 == 0) {
                                ...
                                distributeKeyframes(keyframeArr, keyframeArr[size + 1].getFraction() - keyframeArr[i3 - 1].getFraction(), i3, size);
                            }
                        }
                    }
