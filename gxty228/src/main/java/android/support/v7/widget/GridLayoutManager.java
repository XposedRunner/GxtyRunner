...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    void layoutChunk(Recycler recycler, State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        ...
        Object obj = modeInOther != MemoryConstants.GB ? 1 : null;
        ...
        if (obj != null) {
            ...
            while (spanSize < i2) {
                ...
                measureChild(view2, MemoryConstants.GB, true);
        ...
        for (i3 = 0; i3 < i2; i3++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i5) {
                ...
                if (this.mOrientation == 1) {
                    spanSize = LayoutManager.getChildMeasureSpec(spaceForSpanRange, MemoryConstants.GB, spanSize, layoutParams.width, false);
                    i4 = MeasureSpec.makeMeasureSpec(i5 - i6, MemoryConstants.GB);
                } else {
                    spanSize = MeasureSpec.makeMeasureSpec(i5 - spanSize, MemoryConstants.GB);
                    i4 = LayoutManager.getChildMeasureSpec(spaceForSpanRange, MemoryConstants.GB, i6, layoutParams.height, false);
                }
