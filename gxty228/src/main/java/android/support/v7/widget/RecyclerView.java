...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2, ScrollingView {
    ...
    public static abstract class LayoutManager {
        ...
        public static int getChildMeasureSpec(int i, int i2, int i3, int i4, boolean z) {
            ...
            if (z) {
                ...
                if (i4 == -2) {
                    if (i2 == Integer.MIN_VALUE || i2 == MemoryConstants.GB) {
        ...
        void setExactMeasureSpecsFrom(RecyclerView recyclerView) {
            setMeasureSpecs(MeasureSpec.makeMeasureSpec(recyclerView.getWidth(), MemoryConstants.GB), MeasureSpec.makeMeasureSpec(recyclerView.getHeight(), MemoryConstants.GB));
        }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (this.mLayout == null) {
            ...
            if (mode == MemoryConstants.GB && mode2 == MemoryConstants.GB) {
                z = true;
            }
            ...
            if (!z && this.mAdapter != null) {
                ...
                if (this.mLayout.shouldMeasureTwice()) {
                    this.mLayout.setMeasureSpecs(MeasureSpec.makeMeasureSpec(getMeasuredWidth(), MemoryConstants.GB), MeasureSpec.makeMeasureSpec(getMeasuredHeight(), MemoryConstants.GB));
                    this.mState.mIsMeasuring = true;
                    dispatchLayoutStep2();
                    this.mLayout.setMeasuredDimensionFromChildren(i, i2);
                }
