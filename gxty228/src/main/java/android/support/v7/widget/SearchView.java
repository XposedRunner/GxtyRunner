...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        private int getSearchViewTextMinWidthDp() {
            ...
            if (i >= OtherError.CONTAINER_INVISIBLE_ERROR || (i >= GlMapUtil.DEVICE_DISPLAY_DPI_XXHIGH && i2 >= GlMapUtil.DEVICE_DISPLAY_DPI_XHIGH)) {
                return 192;
            }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        super.onMeasure(MeasureSpec.makeMeasureSpec(size, MemoryConstants.GB), MeasureSpec.makeMeasureSpec(mode, MemoryConstants.GB));
    }
    ...
    private Intent createVoiceAppSearchIntent(Intent intent, SearchableInfo searchableInfo) {
        ...
        Parcelable activity = PendingIntent.getActivity(getContext(), 0, intent2, MemoryConstants.GB);
