...
public class ActionMenuView extends LinearLayoutCompat implements ItemInvoker, MenuView {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.mFormatItems = MeasureSpec.getMode(i) == MemoryConstants.GB;
        ...
        if (obj2 != null) {
            for (paddingLeft = 0; paddingLeft < childCount; paddingLeft++) {
                ...
                if (layoutParams.expanded) {
                    childAt.measure(MeasureSpec.makeMeasureSpec(layoutParams.extraPixels + (layoutParams.cellsUsed * i6), MemoryConstants.GB), childMeasureSpec);
                }
            }
        }
        if (mode == 1073741824) {
    ...
    static int measureChildForCells(View view, int i, int i2, int i3, int i4) {
        ...
        view.measure(MeasureSpec.makeMeasureSpec(i5 * i, MemoryConstants.GB), makeMeasureSpec);
        return i5;
    }
