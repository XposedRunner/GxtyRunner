...
public class ScrollingTabContainerView extends HorizontalScrollView implements OnItemSelectedListener {
    ...
    private class TabView extends LinearLayoutCompat {
        ...
        public void onMeasure(int i, int i2) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0 && getMeasuredWidth() > ScrollingTabContainerView.this.mMaxTabWidth) {
                super.onMeasure(MeasureSpec.makeMeasureSpec(ScrollingTabContainerView.this.mMaxTabWidth, MemoryConstants.GB), i2);
            }
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        boolean z = mode == MemoryConstants.GB;
        setFillViewport(z);
        int childCount = this.mTabLayout.getChildCount();
        if (childCount <= 1 || !(mode == MemoryConstants.GB || mode == Integer.MIN_VALUE)) {
            this.mMaxTabWidth = -1;
        } else {
            if (childCount > 2) {
        ...
        mode = MeasureSpec.makeMeasureSpec(this.mContentHeight, MemoryConstants.GB);
