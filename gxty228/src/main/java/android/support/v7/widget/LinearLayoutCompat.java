...
public class LinearLayoutCompat extends ViewGroup {
        ...
        while (i11 < virtualChildCount) {
            ...
            if (virtualChildAt2 == null) {
                ...
                if (i11 >= i9 || layoutParams.weight <= 0.0f) {
                    ...
                    i5 = Math.max(i5, i13);
                    int combineMeasuredStates = View.combineMeasuredStates(i6, virtualChildAt2.getMeasuredState());
                ...
                if (virtualChildAt3.getVisibility() == 8) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        if (layoutParams2.height == 0 && mode2 == 1073741824) {
                            ...
                            virtualChildAt3.measure(i12, MeasureSpec.makeMeasureSpec(i4, MemoryConstants.GB));
                        } else {
                        ...
                        f4 = f3;
                        i11 = i15;
                        i15 = View.combineMeasuredStates(i16, virtualChildAt3.getMeasuredState() & InputDeviceCompat.SOURCE_ANY);
                        f5 = f4;
                    } else {
                        f5 = f3;
                        i11 = i15;
            ...
            if (z && mode2 != 1073741824) {
                for (i4 = 0; i4 < virtualChildCount; i4++) {
                    ...
                    if (!(virtualChildAt == null || virtualChildAt.getVisibility() == 8 || ((LayoutParams) virtualChildAt.getLayoutParams()).weight <= 0.0f)) {
                        virtualChildAt.measure(MeasureSpec.makeMeasureSpec(virtualChildAt.getMeasuredWidth(), MemoryConstants.GB), MeasureSpec.makeMeasureSpec(i10, MemoryConstants.GB));
                    }
                }
            }
            i3 = i17;
    ...
    private void forceUniformWidth(int i, int i2) {
        int makeMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredWidth(), MemoryConstants.GB);
    ...
    void measureHorizontal(int i, int i2) {
                ...
                if (virtualChildAt3 == null) {
                    ...
                    if (f6 > 0.0f) {
                        ...
                        if (layoutParams.width == 0 && mode == 1073741824) {
                            ...
                            virtualChildAt3.measure(MeasureSpec.makeMeasureSpec(i5, MemoryConstants.GB), i14);
                        } else {
                        ...
                        i9 = View.combineMeasuredStates(i15, virtualChildAt3.getMeasuredState() & ViewCompat.MEASURED_STATE_MASK);
                        f5 = f3;
                    } else {
                        i4 = i14;
                        i9 = i15;
            ...
            if (z2 && mode != 1073741824) {
                for (i5 = 0; i5 < virtualChildCount; i5++) {
                    ...
                    if (!(virtualChildAt4 == null || virtualChildAt4.getVisibility() == 8 || ((LayoutParams) virtualChildAt4.getLayoutParams()).weight <= 0.0f)) {
                        virtualChildAt4.measure(MeasureSpec.makeMeasureSpec(i10, MemoryConstants.GB), MeasureSpec.makeMeasureSpec(virtualChildAt4.getMeasuredHeight(), MemoryConstants.GB));
                    }
                }
            }
            i3 = i16;
        ...
        setMeasuredDimension((ViewCompat.MEASURED_STATE_MASK & i7) | resolveSizeAndState, View.resolveSizeAndState(Math.max(i3 + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), i2, i7 << 16));
        if (obj4 != null) {
    ...
    private void forceUniformHeight(int i, int i2) {
        int makeMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredHeight(), MemoryConstants.GB);
        for (int i3 = 0; i3 < i; i3++) {
            View virtualChildAt = getVirtualChildAt(i3);
            if (virtualChildAt.getVisibility() != 8) {
                LayoutParams layoutParams = (LayoutParams) virtualChildAt.getLayoutParams();
