...
public class ActionMenuItemView extends AppCompatTextView implements ItemView, ActionMenuChildView, OnClickListener {
    ...
    private boolean shouldAllowTextWithIcon() {
        ...
        return i >= GlMapUtil.DEVICE_DISPLAY_DPI_XHIGH || ((i >= GlMapUtil.DEVICE_DISPLAY_DPI_XXHIGH && configuration.screenHeightDp >= GlMapUtil.DEVICE_DISPLAY_DPI_XHIGH) || configuration.orientation == 2);
    }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (mode != MemoryConstants.GB && this.mMinWidth > 0 && measuredWidth < size) {
            super.onMeasure(MeasureSpec.makeMeasureSpec(size, MemoryConstants.GB), i2);
        }
