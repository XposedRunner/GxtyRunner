...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, OnKeyListener, OnDismissListener {
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (this.mShowingMenus.size() > 0) {
            CascadingMenuInfo cascadingMenuInfo = (CascadingMenuInfo) this.mShowingMenus.get(this.mShowingMenus.size() - 1);
        ...
        if (findParentViewForSubmenu != null) {
            ...
            if ((this.mDropDownGravity & 5) == 5) {
                if (z) {
                    i2 = i + measureIndividualMenuWidth;
                } else {
                    i2 = i - findParentViewForSubmenu.getWidth();
                }
            } else if (z) {
                i2 = findParentViewForSubmenu.getWidth() + i;
            } else {
                i2 = i - measureIndividualMenuWidth;
            }
        ...
        if (cascadingMenuInfo2 == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
