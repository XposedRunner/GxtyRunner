...
public final class Cache implements Closeable, Flushable {
    ...
    private static final class Entry {
        ...
        public Response response(Snapshot snapshot) {
            String str = this.responseHeaders.get(com.lzy.okgo.model.HttpHeaders.HEAD_KEY_CONTENT_TYPE);
            String str2 = this.responseHeaders.get(com.lzy.okgo.model.HttpHeaders.HEAD_KEY_CONTENT_LENGTH);
    ...
    CacheRequest put(Response response) {
        ...
        } else if (!method.equals(Constants.HTTP_GET) || HttpHeaders.hasVaryAll(response)) {
            return null;
        } else {
