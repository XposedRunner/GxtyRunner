...
public class m implements IXAdPackageUtils {
    ...
    public static boolean b(Context context) {
        ...
        try {
            ...
            if (externalFilesDir == null || !c(context, k.a(externalFilesDir.getPath()))) {
                return false;
            }
            return true;
        } catch (Exception e) {
    ...
    public static boolean c(Context context) {
        if (XAdSDKFoundationFacade.getInstance().getCommonUtils().checkSelfPermission(context, "android.permission.WRITE_EXTERNAL_STORAGE") && c(context, k.a(Environment.getExternalStorageDirectory().getPath()))) {
            return true;
        }
        return false;
    }
    ...
    public void sendAPOIsSuccess(Context context, boolean z, int i, String str, String str2) {
        ...
        try {
            b bVar = new b(uRIUitls.addParameters(commonUtils.vdUrl(stringBuilder.toString(), 369), null), "");
            bVar.e = 1;
    ...
    public boolean sendAPOInfo(Context context, String str, String str2, int i, int i2, int i3) {
        ...
        try {
            b bVar = new b(uRIUitls.addParameters(commonUtils.vdUrl(str4 + str3, i), null), "");
            bVar.e = 1;
            new com.baidu.mobads.openad.d.a().a(bVar);
        } catch (Exception e2) {
    ...
    public void sendDialerIsSuccess(Context context, boolean z, int i, String str) {
        ...
        try {
            b bVar = new b(uRIUitls.addParameters(commonUtils.vdUrl(stringBuilder.toString(), 372), null), "");
            bVar.e = 1;
            new com.baidu.mobads.openad.d.a().a(bVar);
        } catch (Exception e) {
            XAdSDKFoundationFacade.getInstance().getAdLogger().d("XAdPackageUtils", e.getMessage());
