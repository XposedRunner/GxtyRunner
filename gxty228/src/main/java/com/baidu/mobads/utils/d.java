...
public class d implements IXAdCommonUtils {
    ...
    public int getApkDownloadStatus(Context context, String str, String str2) {
        ...
        try {
            ...
            File file = new File(k.a(context) + optString);
            if (i != 3) {
                return i;
            }
            Object obj = null;
    ...
    public String vdUrl(String str, int i) {
        ...
        StringBuilder stringBuilder = new StringBuilder("type=" + i + HttpUtils.PARAMETERS_SEPARATOR);
        ...
        for (String str22 : treeMap.keySet()) {
            ...
            if (!(str22 == null || str3 == null)) {
                ...
                stringBuilder.append(str22 + HttpUtils.EQUAL_SIGN + str3 + HttpUtils.PARAMETERS_SEPARATOR);
                stringBuilder2.append(str3 + ",");
            }
        }
        stringBuilder2.append("mobads,");
        stringBuilder.append("vd=" + getMD5(stringBuilder2.toString()) + HttpUtils.PARAMETERS_SEPARATOR);
    ...
    public String b() {
        return "android_8.7052_4.0.0";
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public boolean hasSupportedApps(android.content.Context r6, int r7) {
        /*
        r5 = this;
        r1 = 1;
        r2 = 0;
        r0 = com.baidu.mobads.utils.XAdSDKFoundationFacade.getInstance();	 Catch:{ Exception -> 0x005b }
        r0 = r0.getSystemUtils();	 Catch:{ Exception -> 0x005b }
        switch(r7) {
    ...
    L_0x000d:
        return r2;
    L_0x000e:
        r0 = new android.content.Intent;	 Catch:{ Exception -> 0x005b }
        r3 = "android.intent.action.SENDTO";
        r0.<init>(r3);	 Catch:{ Exception -> 0x005b }
        r3 = "mailto:baidumobadstest@baidu.com";
        r3 = android.net.Uri.parse(r3);	 Catch:{ Exception -> 0x005b }
        r0.setData(r3);	 Catch:{ Exception -> 0x005b }
    L_0x001e:
        r3 = new java.util.ArrayList;	 Catch:{ Exception -> 0x005b }
        r3.<init>();	 Catch:{ Exception -> 0x005b }
        r3 = r6.getPackageManager();	 Catch:{ Exception -> 0x005b }
        r4 = 64;
        r0 = r3.queryIntentActivities(r0, r4);	 Catch:{ Exception -> 0x005b }
        if (r0 == 0) goto L_0x000d;
    L_0x002f:
        r3 = r0.size();	 Catch:{ Exception -> 0x005b }
        if (r3 <= 0) goto L_0x000d;
    L_0x0035:
        r3 = 0;
        r0 = r0.get(r3);	 Catch:{ Exception -> 0x005b }
        r0 = (android.content.pm.ResolveInfo) r0;	 Catch:{ Exception -> 0x005b }
        r0 = r0.activityInfo;	 Catch:{ Exception -> 0x005b }
        r0 = r0.packageName;	 Catch:{ Exception -> 0x005b }
        r3 = "com.android.fallback";
        r0 = r0.equals(r3);	 Catch:{ Exception -> 0x005b }
        if (r0 != 0) goto L_0x000d;
    L_0x0048:
        r2 = r1;
        goto L_0x000d;
    ...
    L_0x005d:
        r0 = com.baidu.mobads.utils.XAdSDKFoundationFacade.getInstance();	 Catch:{ Exception -> 0x005b }
        r0 = r0.getCommonUtils();	 Catch:{ Exception -> 0x005b }
        r3 = "android.permission.ACCESS_WIFI_STATE";
        r0 = r0.hasPermission(r6, r3);	 Catch:{ Exception -> 0x005b }
        if (r0 == 0) goto L_0x0080;
    L_0x006d:
        r0 = com.baidu.mobads.utils.XAdSDKFoundationFacade.getInstance();	 Catch:{ Exception -> 0x005b }
        r0 = r0.getCommonUtils();	 Catch:{ Exception -> 0x005b }
        r3 = "android.permission.CHANGE_WIFI_STATE";
        r0 = r0.hasPermission(r6, r3);	 Catch:{ Exception -> 0x005b }
        if (r0 == 0) goto L_0x0080;
    L_0x007d:
        r0 = r1;
    ...
    L_0x0082:
        ...
        r0.setType(r3);	 Catch:{ Exception -> 0x005b }
        goto L_0x001e;
    L_0x008f:
        r0 = r0.canSupportSdcardStroage(r6);	 Catch:{ Exception -> 0x005b }
        if (r0 == 0) goto L_0x00a5;
    L_0x0095:
        r0 = com.baidu.mobads.utils.XAdSDKFoundationFacade.getInstance();	 Catch:{ Exception -> 0x005b }
        r0.getPackageUtils();	 Catch:{ Exception -> 0x005b }
        r0 = com.baidu.mobads.utils.m.b(r6);	 Catch:{ Exception -> 0x005b }
        if (r0 == 0) goto L_0x00a5;
    L_0x00a2:
        r2 = r1;
        goto L_0x000d;
    ...
    public String getApkFileLocalPath(Context context, String str) {
        try {
            ...
            if (!TextUtils.isEmpty(string)) {
                ...
                string = jSONObject.optString(Progress.FOLDER);
    ...
    public void sendDownloadAdLog(Context context, int i, String str, String str2, String str3, String str4, String str5, String str6, String str7, String str8, int i2) {
        try {
            ...
            b bVar = new b(uRIUitls.addParameters(vdUrl(stringBuilder.toString(), i), null), "");
            bVar.e = 1;
