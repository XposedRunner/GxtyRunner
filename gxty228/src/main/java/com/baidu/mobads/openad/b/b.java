...
public class b implements Observer {
    ...
    public void update(Observable observable, Object obj) {
        ...
        if (this.c.g == DownloadStatus.COMPLETED) {
            ...
            if (a != null) {
                com.baidu.mobads.production.b.f().getXMonitorActivation(this.d, l.a()).addAppInfoForMonitor(a);
            }
    ...
    private Notification b(IOAdDownloader iOAdDownloader) {
        ...
        Intent intent = new Intent(this.d, AppActivity.b());
        ...
        PendingIntent activity = PendingIntent.getActivity(this.d, this.c.f, intent, AMapEngineUtils.HALF_MAX_P20_WIDTH);
