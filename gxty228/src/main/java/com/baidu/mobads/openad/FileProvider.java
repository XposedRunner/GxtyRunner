...
public class FileProvider extends ContentProvider {
    ...
    private static final File b = new File(HttpUtils.PATHS_SEPARATOR);
    ...
    static class b implements a {
        ...
        public Uri a(File file) {
            try {
                ...
                return new Builder().scheme("content").authority(this.a).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(path, HttpUtils.PATHS_SEPARATOR)).build();
            } catch (IOException e) {
