...
public class a {
    ...
    private void a(Context context, String str, IXAppInfo iXAppInfo) {
        c cVar = new c(context, iXAppInfo);
    ...
    private String a(Context context, String str, Map<String, String> map) {
        try {
            ...
            StringBuilder stringBuilder = new StringBuilder("type=" + str + HttpUtils.PARAMETERS_SEPARATOR);
            ...
            stringBuilder.append("vd=" + encodeURIComponent2 + HttpUtils.PARAMETERS_SEPARATOR);
