...
public class q implements IXAdContainerEventListener {
    ...
    private void a(Context context, String str, String str2) {
        try {
            ...
            timer.schedule(new r(this, XAdSDKFoundationFacade.getInstance().getPackageUtils(), context, str2, timer, str), 0, 1000);
        } catch (Exception e) {
        }
    }
    ...
    private void a(Context context, String str) {
        try {
            this.j = 0;
            Timer timer = new Timer();
            timer.schedule(new s(this, XAdSDKFoundationFacade.getInstance().getPackageUtils(), context, str, timer), 0, 1000);
        } catch (Exception e) {
        }
    }
    ...
    L_0x00ff:
        ...
        r9 = new com.baidu.mobads.openad.d.b;	 Catch:{ Exception -> 0x032a }
        r11 = "";
    ...
    private void a(Set<String> set) {
        ...
        for (String bVar : set) {
            b bVar2 = new b(bVar, "");
            bVar2.e = 1;
            aVar.a(bVar2, Boolean.valueOf(true));
        }
    }
}
