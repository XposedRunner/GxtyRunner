...
public class b extends com.baidu.mobads.production.b implements IXLinearAdSlot, IOAdEventDispatcher {
    ...
    public void request() {
        ...
        String str = (String) parameter.get("BASE_WIDTH");
        String str2 = (String) parameter.get("BASE_HEIGHT");
        if (str != null) {
            try {
    ...
    private void a(Set<String> set) {
        a aVar = new a();
        for (String bVar : set) {
            com.baidu.mobads.openad.d.b bVar2 = new com.baidu.mobads.openad.d.b(bVar, "");
            bVar2.e = 1;
