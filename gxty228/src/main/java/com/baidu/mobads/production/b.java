...
public abstract class b extends c implements IXNonLinearAdSlot {
    ...
    private static final String[] w = new String[]{"android.permission.READ_PHONE_STATE", "android.permission.ACCESS_COARSE_LOCATION", "android.permission.WRITE_EXTERNAL_STORAGE"};
    private Handler A = new Handler(Looper.getMainLooper());
    private Runnable B = null;
    private IOAdEventListener C = new c(this);
    ...
    protected int m = GLMapStaticValue.TMC_REFRESH_TIMELIMIT;
    protected int n = 0;
    ...
    protected abstract void a(com.baidu.mobads.openad.d.b bVar, v vVar, int i);
    ...
    private void q() {
        ...
        a(this.y);
        if (d()) {
            IXAdInstanceInfo primaryAdInstanceInfo = this.y.getPrimaryAdInstanceInfo();
    ...
    public boolean c(IXAdInstanceInfo iXAdInstanceInfo) {
        return iXAdInstanceInfo.getCreativeType() == CreativeType.STATIC_IMAGE || iXAdInstanceInfo.getCreativeType() == CreativeType.GIF;
    }
    ...
    public boolean d(IXAdInstanceInfo iXAdInstanceInfo) {
        return (iXAdInstanceInfo.getCreativeType() == CreativeType.RM && this.r.endsWith("vr")) || iXAdInstanceInfo.getCreativeType() == CreativeType.VIDEO;
    }
    ...
    protected void b(d dVar) {
        ...
        com.baidu.mobads.openad.d.b bVar = new com.baidu.mobads.openad.d.b(b, "");
        bVar.e = 1;
        this.j.addEventListener("URLLoader.Load.Complete", this.C);
        this.j.addEventListener("URLLoader.Load.Error", this.C);
    ...
    protected void m() {
        if (this.B != null) {
            this.A.postDelayed(this.B, (long) this.m);
        }
    }
