        ...
        try {
            ...
            for (String str : hashMap.keySet()) {
                ...
                if (!(str2 == null || str3 == null)) {
                    str2 = a(str2);
                    str3 = a(str3);
                    stringBuilder.append(str2 + HttpUtils.EQUAL_SIGN + str3 + HttpUtils.PARAMETERS_SEPARATOR);
                    stringBuilder2.append(str3 + ",");
                }
            }
            stringBuilder2.append("mobads,");
            stringBuilder.append("vd=" + commonUtils.getMD5(stringBuilder2.toString()) + HttpUtils.PARAMETERS_SEPARATOR);
