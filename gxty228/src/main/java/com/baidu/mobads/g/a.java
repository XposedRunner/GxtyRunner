    ...
    public IXAdContainerFactory a() {
        if (e == null) {
            try {
                ...
                e.handleShakeVersion(this.d, "8.7052");
            } catch (Throwable th) {
                this.g.w("XAdContainerFactoryBuilder", th.getMessage());
                com.baidu.mobads.g.g.a aVar = new com.baidu.mobads.g.g.a("newXAdContainerFactory() failed, possibly API incompatible: " + th.getMessage());
            }
        }
        return e;
    }
