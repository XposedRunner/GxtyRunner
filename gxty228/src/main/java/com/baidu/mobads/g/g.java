...
public class g {
    ...
    private void k() {
        try {
            ...
            while (listFiles != null && i < listFiles.length) {
                if (listFiles[i].getAbsolutePath().contains("__xadsdk__remote__final__") && listFiles[i].getAbsolutePath().endsWith(TinkerManager.PATCH_DIR)) {
                    listFiles[i].delete();
                }
                i++;
            }
    ...
    private static void c(Context context) {
        if (TextUtils.isEmpty(e)) {
            e = context.getDir("baidu_ad_sdk", 0).getAbsolutePath() + HttpUtils.PATHS_SEPARATOR;
        }
    }
    ...
    protected void a(String str) {
        if (b != null) {
            Editor edit = l().edit();
            edit.putFloat("__badApkVersion__8.7052", (float) b.a);
    ...
    private static synchronized void d(Context context) {
        synchronized (g.class) {
            try {
                String c = c();
                if (Double.valueOf("8.7052").doubleValue() > a(context, c)) {
        ...
        if (k.a((File) bVar)) {
            try {
                ...
                synchronized (this) {
                    ...
                    b(bVar);
                    double d = (double) l().getFloat("__badApkVersion__8.7052", -1.0f);
    ...
    public static double b(Context context) {
        try {
            ...
            String d = d();
            if (Double.valueOf("8.7052").doubleValue() > a(context, d)) {
