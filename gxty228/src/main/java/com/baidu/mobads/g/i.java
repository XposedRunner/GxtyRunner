...
class i extends Handler {
    ...
    L_0x0021:
        ...
        r3 = r3.l;
        r1.<init>(r2, r3, r0);
        r2 = r7.a;	 Catch:{ a -> 0x0087 }
        r2 = r2.g;	 Catch:{ a -> 0x0087 }
        r3 = com.baidu.mobads.g.g.f;	 Catch:{ a -> 0x0087 }
        if (r2 != r3) goto L_0x0072;
    L_0x0038:
        r1.a();	 Catch:{ a -> 0x0087 }
        r2 = com.baidu.mobads.g.g.f();	 Catch:{ a -> 0x0087 }
        r1.a(r2);	 Catch:{ a -> 0x0087 }
        r2 = com.baidu.mobads.g.g.b;	 Catch:{ a -> 0x0087 }
        if (r2 == 0) goto L_0x004e;
    L_0x0046:
        r2 = com.baidu.mobads.g.g.b;	 Catch:{ a -> 0x0087 }
        r4 = r0.b();	 Catch:{ a -> 0x0087 }
        r2.a = r4;	 Catch:{ a -> 0x0087 }
    L_0x004e:
        r0 = r7.a;	 Catch:{ a -> 0x0087 }
        r0.k();	 Catch:{ a -> 0x0087 }
        r0 = r7.a;	 Catch:{ a -> 0x0087 }
        r0 = r0.n;	 Catch:{ a -> 0x0087 }
        if (r0 == 0) goto L_0x006e;
    L_0x005b:
        r0 = r7.a;	 Catch:{ a -> 0x0087 }
        r2 = 0;
        r0.n = r2;	 Catch:{ a -> 0x0087 }
        r0 = r7.a;	 Catch:{ a -> 0x0087 }
        r2 = r7.a;	 Catch:{ a -> 0x0087 }
        r2 = r2.p();	 Catch:{ a -> 0x0087 }
        r3 = "load remote file just downloaded";
        r0.a(r2, r3);	 Catch:{ a -> 0x0087 }
    L_0x006e:
        r1.delete();
    L_0x0071:
        return;
    L_0x0072:
        r0 = r7.a;	 Catch:{ a -> 0x0087 }
        r0.a(r1);	 Catch:{ a -> 0x0087 }
        r0 = r7.a;	 Catch:{ a -> 0x0087 }
        r0 = com.baidu.mobads.g.g.f();	 Catch:{ a -> 0x0087 }
        r1.a(r0);	 Catch:{ a -> 0x0087 }
        r0 = r7.a;	 Catch:{ a -> 0x0087 }
        r2 = 1;
        r0.a(r2);	 Catch:{ a -> 0x0087 }
        goto L_0x006e;
    L_0x0087:
        r0 = move-exception;
        ...
        r3 = 0;
        r2.a(r3);	 Catch:{ all -> 0x00bd }
        r2 = r7.a;	 Catch:{ all -> 0x00bd }
        r2 = r2.m;	 Catch:{ all -> 0x00bd }
        r3 = 2;
