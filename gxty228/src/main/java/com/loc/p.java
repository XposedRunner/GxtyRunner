...
public final class p {
    private static Map<Class<? extends o>, o> d = new HashMap();
    private s a;
    ...
    public p(Context context, o oVar) {
        try {
            this.a = new s(context.getApplicationContext(), oVar.a(), oVar);
        } catch (Throwable th) {
            th.printStackTrace();
        }
        this.c = oVar;
    ...
    public p(Context context, o oVar, String str) {
        try {
            ...
            this.a = new s(context, oVar.a(), oVar);
        } catch (Throwable th) {
            th.printStackTrace();
        }
        this.c = oVar;
    ...
    private static android.content.ContentValues a(java.lang.Object r8, com.loc.q r9) {
        /*
    ...
    L_0x00a4:
        return r3;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.loc.p.a(java.lang.Object, com.loc.q):android.content.ContentValues");
    }
    ...
    public static synchronized o a(Class<? extends o> cls) throws IllegalAccessException, InstantiationException {
        o oVar;
    ...
    private static <T> T a(Cursor cursor, Class<T> cls, q qVar) throws IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException {
        Field[] a = a((Class) cls, qVar.b());
    ...
    private static <T> String a(q qVar) {
    ...
    private static <T> q b(Class<T> cls) {
        Annotation annotation = cls.getAnnotation(q.class);
        return (annotation != null ? 1 : null) == null ? null : (q) annotation;
    }
    ...
    L_0x0065:
        r2 = "dbs";
        r3 = "sld";
        com.loc.g.a(r0, r2, r3);	 Catch:{ all -> 0x0103 }
    L_0x006c:
    ...
    L_0x009a:
        r2 = "dbs";
        r3 = "sld";
        com.loc.g.a(r1, r2, r3);	 Catch:{ all -> 0x0094 }
        goto L_0x0087;
    L_0x00a2:
        r1 = move-exception;
    ...
    L_0x00b0:
        r1 = "dbs";
        r2 = "sld";
        com.loc.g.a(r0, r1, r2);	 Catch:{ all -> 0x0094 }
        goto L_0x0071;
    L_0x00b8:
        r0 = move-exception;
    ...
    L_0x0106:
        ...
        goto L_0x0063;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.loc.p.a(java.lang.String, java.lang.Class, boolean):java.util.List<T>");
    }
