...
public final class bd {
    ...
    private List<DPoint> a(List<DPoint> list, float f) {
        ...
        for (int i2 = 1; i2 < list.size() - 1; i2++) {
            ...
            Object obj = (dPoint.getLongitude() == dPoint2.getLongitude() && dPoint.getLatitude() == dPoint2.getLatitude()) ? 1 : null;
            if (longitude3 < Utils.DOUBLE_EPSILON || obj != null) {
            ...
            longitude3 = (double) ct.a(new DPoint(dPoint3.getLatitude(), dPoint3.getLongitude()), new DPoint(longitude3, longitude));
            if (longitude3 > d) {
                i = i2;
                d = longitude3;
            }
