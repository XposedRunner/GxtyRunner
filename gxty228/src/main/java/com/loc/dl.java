...
public final class dl {
    ...
    public static String a(Context context) {
        ...
        if (VERSION.SDK_INT >= 21) {
            try {
                ...
                obj = (String) declaredField.get(applicationInfo);
            } catch (Throwable th) {
                g.a(th, "ut", "gct");
            }
            return TextUtils.isEmpty(obj) ? Build.CPU_ABI : obj;
        }
        String str2 = str;
    ...
    public static byte[] b() {
        ...
        try {
            ...
            split = new StringBuffer(new String(dg.b(new String(bArr)))).reverse().toString().split(",");
    ...
    public static String c(String str) {
        return str.length() < 2 ? "" : dg.a(str.substring(1));
    }
    ...
    static PublicKey c() throws CertificateException, InvalidKeySpecException, NoSuchAlgorithmException, NullPointerException, IOException {
        ...
        try {
            byteArrayInputStream = new ByteArrayInputStream(dg.b(""));
            try {
