...
public final class bz {
    ...
    public static String a(String str, String str2) {
        ...
        if (str2 != null) {
            try {
                byte[] a = dh.a(str2.getBytes("UTF-8"), str);
                int length = a.length;
    ...
    public static byte[] a(byte[] bArr) {
        ...
        try {
            ...
            cl.a(th, "Encrypt", "decryptRsponse length = " + i);
            return null;
        }
    }
    ...
    public static synchronized byte[] a(byte[] bArr, String str) throws Exception {
        ...
        synchronized (bz.class) {
            Key generatePrivate = KeyFactory.getInstance("RSA").generatePrivate(new PKCS8EncodedKeySpec(dg.b(str)));
    ...
    public static byte[] c(byte[] bArr, String str) {
        try {
            Key b = b(str);
            AlgorithmParameterSpec ivParameterSpec = new IvParameterSpec(dl.b());
            Cipher instance = Cipher.getInstance("AES/CBC/PKCS5Padding");
            instance.init(1, b, ivParameterSpec);
            return instance.doFinal(bArr);
        } catch (Throwable th) {
            cl.a(th, "Encrypt", "aesEncrypt");
            return null;
        }
    }
