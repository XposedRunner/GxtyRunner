...
public final class cm {
    ...
    private static DPoint a(DPoint dPoint, boolean z) {
        double[] a;
        try {
            if (!cl.a(dPoint.getLatitude(), dPoint.getLongitude())) {
                return dPoint;
            }
            double[] dArr = new double[2];
            if (z) {
                a = CoordUtil.convertToGcj(new double[]{dPoint.getLongitude(), dPoint.getLatitude()}, dArr) != 0 ? cu.a(dPoint.getLongitude(), dPoint.getLatitude()) : dArr;
            } else {
                a = cu.a(dPoint.getLongitude(), dPoint.getLatitude());
            }
            return new DPoint(a[1], a[0]);
        } catch (Throwable th) {
            cl.a(th, "OffsetUtil", "cover part2");
            return dPoint;
        }
    }
    ...
    public static DPoint b(Context context, DPoint dPoint) {
        try {
            ...
            dPoint = a(context, new DPoint(((double) ((int) (((double) (latitude > Utils.DOUBLE_EPSILON ? 1 : -1)) + ((-b((double) i2, (double) i)) + latitude)))) / 100000.0d, ((double) i2) / 100000.0d));
        } catch (Throwable th) {
            cl.a(th, "OffsetUtil", "marbar2G");
        }
        return dPoint;
    }
