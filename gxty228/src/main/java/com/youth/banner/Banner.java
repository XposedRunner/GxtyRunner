...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    public void onPageSelected(int i) {
        ...
        switch (this.bannerStyle) {
            case 2:
                this.numIndicator.setText(i + HttpUtils.PATHS_SEPARATOR + this.count);
                return;
            case 3:
                this.numIndicatorInside.setText(i + HttpUtils.PATHS_SEPARATOR + this.count);
