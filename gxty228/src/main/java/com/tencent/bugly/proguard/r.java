            ...
            if (TinkerManager.isTinkerManagerInstalled()) {
                ...
                TinkerManager.getInstance().setTinkerListener(new TinkerListener() {
                    public void onDownloadSuccess(String str) {
                        if (eVar.W != null) {
                            eVar.W.onDownloadSuccess(str);
                        }
                    }

                    public void onDownloadFailure(String str) {
                        if (eVar.W != null) {
                            eVar.W.onDownloadFailure(str);
                        }
                    }
                        ...
                        while (i < length) {
                            ...
                            if (file2.getName().endsWith(".so")) {
                                ...
                                if (absolutePath.startsWith("lib")) {
                                    substring = absolutePath.substring(absolutePath.indexOf("lib") + 3);
                                } else {
                                ...
                                for (String absolutePath4 : eVar.aa) {
