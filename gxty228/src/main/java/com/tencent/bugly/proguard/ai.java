...
public class ai {
    ...
    public byte[] a(String str, byte[] bArr, al alVar, Map<String, String> map) {
        ...
        an.c("request: %s, send: %d (pid=%d | tid=%d)", str, Long.valueOf(j), Integer.valueOf(Process.myPid()), Integer.valueOf(Process.myTid()));
        Object obj = null;
        String str2 = str;
        while (i3 < 1 && i4 < 1) {
            if (obj != null) {
                ...
                if (i3 > 1) {
                    ...
                    SystemClock.sleep(((long) new Random(System.currentTimeMillis()).nextInt(ByteBufferUtils.ERROR_CODE)) + 10000);
                }
            }
            String f = b.f(this.a);
            if (f == null) {
                ...
                if (a != null) {
                    try {
                        ...
                        if (a(responseCode)) {
                            try {
                                String headerField = a.getHeaderField(HttpHeaders.HEAD_KEY_LOCATION);
                                if (headerField == null) {
                                ...
                                i4++;
                                try {
                                    an.c("redirect code: %d ,to:%s", Integer.valueOf(responseCode), headerField);
                                    obj = 1;
                                    str2 = headerField;
                                    i3 = i4;
                                    i4 = 0;
