...
public class ah {
    public static bh a(UserInfoBean userInfoBean, a aVar) {
        ...
        an.c("summary type %d vm:%d", Byte.valueOf(bhVar.b), Integer.valueOf(bhVar.f.size()));
        return bhVar;
    }
    ...
    public static bi a(List<UserInfoBean> list, int i) {
        ...
        switch (i) {
            ...
            case 2:
                ...
                break;
            default:
                an.e("unknown up type %d ", Integer.valueOf(i));
                return null;
        }
        return biVar;
    }
        ...
        try {
            ...
            synchronized (b) {
                ...
                if (b.I) {
                    ...
                    bdVar.k.put("G5", "" + b.O());
                    bdVar.k.put("G6", "" + b.P());
                    bdVar.k.put("G7", "" + Long.toString(b.Q()));
                }
                bdVar.k.put("D3", "" + b.p);
    ...
    public static be a(byte[] bArr, StrategyBean strategyBean, boolean z) {
        if (bArr != null) {
            try {
                ...
                an.c("resp buf %d", Integer.valueOf(beVar.c.length));
