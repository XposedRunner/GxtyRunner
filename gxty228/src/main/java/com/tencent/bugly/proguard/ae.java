            ...
            if (cursor == null) {
                ...
                try {
                    ...
                    if (str.length() > 0) {
                        ...
                        an.d("[Database] deleted %s illegal data %d", "t_lr", Integer.valueOf(delete));
                    }
                    if (cursor != null) {
                        cursor.close();
                    }
            ...
            if (list.size() != 0) {
                ...
                if (writableDatabase != null) {
                    ...
                    try {
                        ...
                        an.c("[Database] deleted %s data %d", "t_lr", Integer.valueOf(delete));
                        if (a) {
                            writableDatabase.close();
                        }
                    } catch (Throwable th) {
                        ...
                        if (query == null) {
                            ...
                            try {
                                ...
                                if (stringBuilder.length() > 0) {
                                    ...
                                    an.d("[Database] deleted %s illegal data %d.", "t_pf", Integer.valueOf(delete));
                                }
                                if (query != null) {
                                    query.close();
                                }
        ...
        synchronized (this) {
            try {
                ...
                if (sQLiteDatabase != null) {
                    ...
                    an.c("[Database] deleted %s data %d", "t_pf", Integer.valueOf(sQLiteDatabase.delete("t_pf", str2, null)));
