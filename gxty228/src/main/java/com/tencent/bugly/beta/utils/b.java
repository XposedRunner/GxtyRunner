...
public class b {
    ...
    L_0x0009:
        r3 = r7.b;	 Catch:{ IOException -> 0x0030 }
        r4 = a(r3);	 Catch:{ IOException -> 0x0030 }
        r3 = (int) r4;	 Catch:{ IOException -> 0x0030 }
        switch(r3) {
        ...
        };	 Catch:{ IOException -> 0x0030 }
    L_0x0013:
        r0 = "ElfArmAttrParser";
        r1 = "Unimplemented tag.";
        android.util.Log.e(r0, r1);	 Catch:{ IOException -> 0x0030 }
        r0 = r2;
    L_0x001b:
        monitor-exit(r7);
        return r0;
    L_0x001d:
        r3 = r7.d();	 Catch:{ IOException -> 0x0030 }
        if (r3 == 0) goto L_0x0003;
    L_0x0023:
        r3 = r3.length();	 Catch:{ IOException -> 0x0030 }
        r4 = (long) r3;	 Catch:{ IOException -> 0x0030 }
        r0 = r0 - r4;
        goto L_0x0003;
    L_0x002a:
        r3 = r7.b;	 Catch:{ IOException -> 0x0030 }
        a(r3);	 Catch:{ IOException -> 0x0030 }
        goto L_0x0003;
    L_0x0030:
        r0 = move-exception;
        r1 = "ElfArmAttrParser";
        r0 = r0.getMessage();	 Catch:{ all -> 0x0054 }
        android.util.Log.e(r1, r0);	 Catch:{ all -> 0x0054 }
        r0 = r2;
        goto L_0x001b;
    L_0x003c:
        r0 = r7.b;	 Catch:{ IOException -> 0x0030 }
        r0 = a(r0);	 Catch:{ IOException -> 0x0030 }
        r3 = r7.f;	 Catch:{ IOException -> 0x0030 }
        r0 = java.lang.Long.valueOf(r0);	 Catch:{ IOException -> 0x0030 }
        r0 = r3.get(r0);	 Catch:{ IOException -> 0x0030 }
        r0 = (java.lang.String) r0;	 Catch:{ IOException -> 0x0030 }
        r7.e = r0;	 Catch:{ IOException -> 0x0030 }
        r0 = 1;
        goto L_0x001b;
    L_0x0052:
        r0 = r2;
