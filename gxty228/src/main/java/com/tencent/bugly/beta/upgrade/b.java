        ...
        try {
            ...
            if (a != null) {
                ...
                if (a.k != null) {
                    ...
                    an.c("app version is: [%s.%s], [deviceId:%s], channel: [%s], base tinkerId:[%s], patch tinkerId:[%s], patch version:[%s]", eVar.x, Integer.valueOf(eVar.w), b.h(), a.e, eVar.J, eVar.K, eVar.M);
