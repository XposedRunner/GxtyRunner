...
public class TinkerReport {
            ...
            switch (i) {
                ...
                case -3:
                    if (!th.getMessage().contains("checkResInstall failed")) {
                        reporter.onReport((int) KEY_LOADED_EXCEPTION_RESOURCE);
    ...
    public static void onApplyDexOptFail(Throwable th) {
        if (reporter != null) {
            if (th.getMessage().contains("checkDexOptExist failed")) {
                reporter.onReport((int) KEY_APPLIED_DEXOPT_EXIST);
            } else if (th.getMessage().contains("checkDexOptFormat failed")) {
                reporter.onReport((int) KEY_APPLIED_DEXOPT_FORMAT);
            } else {
                reporter.onReport((int) KEY_APPLIED_DEXOPT_OTHER);
    ...
    public static void onApplyInfoCorrupted() {
        if (reporter != null) {
            reporter.onReport((int) KEY_APPLIED_INFO_CORRUPTED);
        }
    }
    ...
    public static void onApplyExtractFail(int i) {
        if (reporter != null) {
            switch (i) {
                case 1:
                    reporter.onReport((int) KEY_APPLIED_PATCH_FILE_EXTRACT);
                    return;
                case 3:
                    reporter.onReport((int) KEY_APPLIED_DEX_EXTRACT);
                    return;
                case 5:
                    reporter.onReport((int) KEY_APPLIED_LIB_EXTRACT);
                    return;
                case 6:
                    reporter.onReport((int) KEY_APPLIED_RESOURCE_EXTRACT);
                    return;
                default:
                    return;
            }
        ...
        if (reporter != null) {
            ...
            if (j < 0) {
                ...
                if (z) {
                    ...
                    reporter.onReport((int) KEY_APPLIED_FAIL_COST_5S_LESS);
                }
            } else if (j <= 10000) {
                if (z) {
                    reporter.onReport((int) KEY_APPLIED_SUCC_COST_10S_LESS);
                } else {
                    reporter.onReport((int) KEY_APPLIED_FAIL_COST_10S_LESS);
                }
            } else if (j <= StatisticConfig.MIN_UPLOAD_INTERVAL) {
                if (z) {
                    reporter.onReport((int) KEY_APPLIED_SUCC_COST_30S_LESS);
                } else {
                    reporter.onReport((int) KEY_APPLIED_FAIL_COST_30S_LESS);
                }
            } else if (j <= 60000) {
                if (z) {
                    reporter.onReport((int) KEY_APPLIED_SUCC_COST_60S_LESS);
                } else {
                    reporter.onReport((int) KEY_APPLIED_FAIL_COST_60S_LESS);
                }
            } else if (z) {
                reporter.onReport((int) KEY_APPLIED_SUCC_COST_OTHER);
            } else {
