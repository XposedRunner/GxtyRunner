...
public class c {
    ...
    public void a(DownloadTask downloadTask) {
        ...
        if (this.i && e.E.R) {
            ...
            contentTitle.setContentText(String.format(locale, str, objArr)).setContentIntent(PendingIntent.getBroadcast(this.h, 1, intent, AMapEngineUtils.MAX_P20_WIDTH)).setAutoCancel(false);
            if (e.E.f > 0) {
