...
public class Beta extends a {
        ...
        synchronized (Beta.class) {
            ...
            if (TextUtils.equals(initProcessName, com.tencent.bugly.crashreport.common.info.a.b().e)) {
                ...
                if (TextUtils.isEmpty(eVar.v)) {
                    ...
                    str = "autoInstallApk %s";
                    objArr = new Object[1];
                    objArr[0] = eVar.ad ? "is opened" : "is closed";
                    an.a(str, objArr);
                    eVar.T = autoDownloadOn4g;
                    str = "autoDownloadOn4g %s";
                    objArr = new Object[1];
                    objArr[0] = eVar.T ? "is opened" : "is closed";
                    an.a(str, objArr);
    ...
    public static synchronized void showUpgradeDialog(String str, int i, String str2, long j, int i2, int i3, String str3, String str4, long j2, String str5, String str6, int i4, DownloadListener downloadListener, Runnable runnable, Runnable runnable2, boolean z) {
        synchronized (Beta.class) {
            ...
            y yVar = new y(str, str2, j, 0, new v(e.E.u, (byte) 1, i3, str3, i2, "", 1, "", str5, "1.3.5", ""), new u(str5, str4, "", j2, ""), (byte) i, 0, 0, null, "", hashMap, null, 1, System.currentTimeMillis(), 1);
            ...
            if (z) {
                ...
                fVar.a(new d(2, objArr), (int) PathInterpolatorCompat.MAX_NUM_POINTS);
            } else {
                fVar = f.a;
                objArr = new Object[2];
                objArr[0] = h.v;
