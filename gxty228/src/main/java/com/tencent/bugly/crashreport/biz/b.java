...
public class b {
    ...
    private static long d = BeaconManager.DEFAULT_BACKGROUND_BETWEEN_SCAN_PERIOD;
                                ...
                                if (b.l == null || b.l.getName().equals(str)) {
                                    ...
                                    if (b != null) {
                                        ...
                                        if (b.v - b.h > (b.f > 0 ? b.f : b.e)) {
                                            b.d();
                                            b.g();
                                            an.a("[session] launch app one times (app in background %d seconds and over %d seconds)", Long.valueOf(r4 / 1000), Long.valueOf(b.e / 1000));
                                            if (b.g % b.c == 0) {
                                                b.b.a(4, b.m, 0);
                                                return;
                                            }
