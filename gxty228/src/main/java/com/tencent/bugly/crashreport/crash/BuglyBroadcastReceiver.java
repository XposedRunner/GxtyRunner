...
public class BuglyBroadcastReceiver extends BroadcastReceiver {
    ...
    public synchronized void register(Context context) {
        ...
        ap.a(new Runnable(this) {
            final /* synthetic */ BuglyBroadcastReceiver b;

            public void run() {
                try {
                    an.a(BuglyBroadcastReceiver.d.getClass(), "Register broadcast receiver of Bugly.", new Object[0]);
                    synchronized (this) {
                        this.b.b.registerReceiver(BuglyBroadcastReceiver.d, this.b.a);
                    }
                } catch (Throwable th) {
                    th.printStackTrace();
                }
                    ...
                    if (this.e) {
                        ...
                        if (f == null) {
                            ...
                            if (a == null || a2 == null || a3 == null) {
                                ...
                                if (currentTimeMillis - a2.a(1001) > StatisticConfig.MIN_UPLOAD_INTERVAL) {
