...
public class b {
    ...
    public boolean a(CrashDetailBean crashDetailBean, int i) {
        ...
        if (this.f != null) {
            ...
            if (!this.f.a(z, str, str2, str3, i, j, str4, str5, str6, crashDetailBean.A)) {
            ...
            if (this.g != null || this.f != null) {
                try {
                    ...
                    if (this.f != null) {
                        ...
                        hashMap = this.g.onCrashHandleStart(i, crashDetailBean.n, crashDetailBean.o, crashDetailBean.q);
                    } else {
                        hashMap = null;
                    }
                    if (hashMap != null && hashMap.size() > 0) {
                        crashDetailBean.P = new LinkedHashMap(hashMap.size());
                        for (Entry entry : hashMap.entrySet()) {
                            if (!ap.a((String) entry.getKey())) {
                                ...
                                if (ap.a((String) entry.getValue()) || ((String) entry.getValue()).length() <= BuglyStrategy.a.MAX_USERDATA_VALUE_LENGTH) {
                                    ...
                                    an.d("setted %s value length is over limit %d substring", b, Integer.valueOf(BuglyStrategy.a.MAX_USERDATA_VALUE_LENGTH));
                                }
                                crashDetailBean.P.put(b, str4);
                                an.a("add setted key %s value size:%d", b, Integer.valueOf(str4.length()));
                            }
                        }
                    }
                    ...
                    if (bArr != null) {
                        if (bArr.length > BuglyStrategy.a.MAX_USERDATA_VALUE_LENGTH) {
        ...
        try {
            ...
            try {
                ...
                if (stringBuilder3.length() > 0) {
                    ...
                    an.d("deleted %s illegle data %d", "t_cr", Integer.valueOf(a3));
                }
                if (a != null) {
                    a.close();
                }
        ...
        try {
            ...
            try {
                ...
                if (stringBuilder2.length() > 0) {
                    ...
                    an.d("deleted %s illegle data %d", "t_cr", Integer.valueOf(a2));
                }
                if (a != null) {
                    a.close();
                }
    ...
    public static bb a(Context context, CrashDetailBean crashDetailBean, com.tencent.bugly.crashreport.common.info.a aVar) {
        ...
        if (crashDetailBean.x != null) {
            ...
            try {
                bbVar.q.add(new ba((byte) 1, "jniLog.txt", crashDetailBean.x.getBytes("utf-8")));
        ...
        if (!ap.a(crashDetailBean.V)) {
            ...
            try {
                baVar = new ba((byte) 1, "crashInfos.txt", crashDetailBean.V.getBytes("utf-8"));
        ...
        if (crashDetailBean.W != null) {
            ...
            a = a("backupRecord.zip", context, crashDetailBean.W);
            if (a != null) {
        ...
        if (crashDetailBean.y != null && crashDetailBean.y.length > 0) {
            a = new ba((byte) 2, "buglylog.zip", crashDetailBean.y);
            if (a != null) {
        ...
        if (crashDetailBean.b == 3) {
            ...
            if (crashDetailBean.P != null && crashDetailBean.P.containsKey("BUGLY_CR_01")) {
                try {
                    bbVar.q.add(new ba((byte) 1, "anrMessage.txt", ((String) crashDetailBean.P.get("BUGLY_CR_01")).getBytes("utf-8")));
        ...
        if (crashDetailBean.U != null && crashDetailBean.U.length > 0) {
            ...
            bbVar.q.add(new ba((byte) 1, "userExtraByteData", crashDetailBean.U));
    ...
    public static ba a(String str, Context context, String str2) {
        ...
        if (ap.a(file, file2, (int) GLMapStaticValue.TMC_REFRESH_TIMELIMIT)) {
            ...
            try {
                ...
                try {
                    ...
                    an.c("read bytes :%d", Integer.valueOf(byteArrayOutputStream.toByteArray().length));
        ...
        if (b != null) {
            ...
            if (crashDetailBean != null) {
                ...
                if (!ap.a(crashDetailBean.L)) {
                    ...
                    String str7;
                    str6 = "# EXCEPTION ANR MESSAGE:\n %s";
                    objArr = new Object[1];
                    if (crashDetailBean.P == null) {
                        str7 = "null";
                    } else {
                        str7 = "" + ((String) crashDetailBean.P.get("BUGLY_CR_01"));
                    }
                    objArr[0] = str7;
                    an.e(str6, objArr);
                }
