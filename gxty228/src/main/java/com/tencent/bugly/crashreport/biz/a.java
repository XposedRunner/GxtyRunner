...
public class a {
    ...
    public void a() {
        this.b = ap.b() + LogBuilder.MAX_INTERVAL;
                ...
                if (a != null) {
                    ...
                    if (a2 != null && (!a2.b() || a.b(1001))) {
                        ...
                        if (a3 != null) {
                            ...
                            if (i > 15) {
                                an.d("[UserInfo] Upload user info too many times in 10 min: %d", Integer.valueOf(i));
                                z2 = false;
                            } else {
                                z2 = true;
                            }
                        ...
                        if (!z2 || list.size() == 0) {
                            ...
                            an.c("[UserInfo] Upload user info(size: %d)", Integer.valueOf(list.size()));
                            ...
                            if (a4 == null) {
                                ...
                                if (a5 == null) {
                                    ...
                                    bd a6 = ah.a(this.a, a.b ? 840 : GlMapUtil.DEVICE_DISPLAY_DPI_XXHIGH, a5);
                                    if (a6 == null) {
    ...
    private void a(UserInfoBean userInfoBean, boolean z) {
        if (userInfoBean != null) {
            if (!(z || userInfoBean.b == 1)) {
                ...
                if (a != null && a.size() >= 20) {
                    an.a("[UserInfo] There are too many user info in local: %d", Integer.valueOf(a.size()));
                    return;
                }
            }
            long a2 = ae.a().a("t_ui", a(userInfoBean), null, true);
            if (a2 >= 0) {
                an.c("[Database] insert %s success with ID: %d", "t_ui", Long.valueOf(a2));
                userInfoBean.a = a2;
            }
        }
    }
        ...
        try {
            ...
            try {
                ...
                if (stringBuilder2.length() > 0) {
                    ...
                    an.d("[Database] deleted %s error data %d", "t_ui", Integer.valueOf(a3));
                }
                if (a != null) {
                    a.close();
                }
    ...
    public void a(List<UserInfoBean> list) {
        if (list != null && list.size() != 0) {
            ...
            try {
                ...
                an.c("[Database] deleted %s data %d", "t_ui", Integer.valueOf(a));
            } catch (Throwable th) {
                if (!an.a(th)) {
                    th.printStackTrace();
                }
