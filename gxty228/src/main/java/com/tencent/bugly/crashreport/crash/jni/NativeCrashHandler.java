...
public class NativeCrashHandler implements a {
    ...
    public static void setShouldHandleInJava(boolean z) {
        o = z;
        if (a != null) {
            a.a((int) GLMapStaticValue.MAPRENDER_CAN_STOP_AND_FULLSCREEN_RENDEROVER, "" + z);
        }
    }
        ...
        if (this.j) {
            ...
            if (this.i) {
                ...
                try {
                    ...
                    if (regist == null) {
                        regist = (String) ap.a("com.tencent.feedback.eup.jni.NativeExceptionUpload", "registNativeExceptionHandler", null, new Class[]{String.class, String.class, Integer.TYPE}, new Object[]{this.f, com.tencent.bugly.crashreport.common.info.b.a(this.b, false), Integer.valueOf(com.tencent.bugly.crashreport.common.info.a.b().K())});
                    }
                    if (regist != null) {
                        this.j = true;
    ...
    public void checkUploadRecordCrash(long j) {
            ...
            public void run() {
                if (ap.a(this.a.b, "native_record_lock", 10000)) {
                    if (!NativeCrashHandler.o) {
                        this.a.a((int) GLMapStaticValue.MAPRENDER_CAN_STOP_AND_FULLSCREEN_RENDEROVER, "false");
                    }
                    ...
                    this.a.b();
                    ap.c(this.a.b, "native_record_lock");
                    return;
                }
    ...
    protected void b() {
        long b = ap.b() - c.g;
        long b2 = LogBuilder.MAX_INTERVAL + ap.b();
        ...
        if (file.exists() && file.isDirectory()) {
            ...
            if (listFiles != null && listFiles.length != 0) {
                ...
                an.c("[Native] Number of record files overdue: %d, has deleted: %d", Integer.valueOf(i2), Integer.valueOf(i));
            }
        }
    }
