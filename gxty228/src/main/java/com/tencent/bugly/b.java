        ...
        if (buglyStrategy != null) {
            ...
            if (!TextUtils.isEmpty(appVersion)) {
                if (appVersion.length() > 100) {
                    ...
                    an.d("appVersion %s length is over limit %d substring to %s", appVersion, Integer.valueOf(100), substring);
                } else {
            ...
            if (!TextUtils.isEmpty(appVersion)) {
                if (appVersion.length() > 100) {
                    substring = appVersion.substring(0, 100);
                    an.d("appPackageName %s length is over limit %d substring to %s", appVersion, Integer.valueOf(100), substring);
                } else {
                    substring = appVersion;
                }
                aVar.d = substring;
            ...
            if (appVersion != null) {
                if (appVersion.length() > 100) {
                    substring = appVersion.substring(0, 100);
                    an.d("deviceId %s length is over limit %d substring to %s", appVersion, Integer.valueOf(100), substring);
                } else {
                    substring = appVersion;
                }
                aVar.c(substring);
                an.a("[param] Set device ID: %s", substring);
            }
