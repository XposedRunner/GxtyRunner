...
public class e {
    ...
    private void b() {
        ...
        new Thread(this) {
            ...
            public void run() {
                try {
                    this.b.a(i.d(HttpUtils.openUrl2(this.b.c, "http://cgi.connect.qq.com/qqconnectopen/openapi/policy_conf", Constants.HTTP_GET, bundle).a));
                } catch (Exception e) {
                    e.printStackTrace();
                }
                this.b.g = 0;
    ...
    private void c() {
        ...
        if (SystemClock.elapsedRealtime() - this.f >= ((long) (optInt * TimeConstants.HOUR))) {
            b();
        }
    }
