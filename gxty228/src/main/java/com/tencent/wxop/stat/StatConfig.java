...
public class StatConfig {
    ...
    private static long H = BeaconManager.DEFAULT_BACKGROUND_BETWEEN_SCAN_PERIOD;
    ...
    static long n = 10000;
    static int o = 512;
    private static StatLogger p = k.b();
            ...
            if (k.c(optString)) {
                ...
                if (jSONObject2.length() != 0) {
                    ...
                    if (a(jSONObject2, "av", k.j(context))) {
                        p.i("match app version:" + k.j(context));
                        obj = 1;
                    }
    ...
    static void b(JSONObject jSONObject) {
        if (jSONObject != null && jSONObject.length() != 0) {
            try {
                ...
                if (isDebugEnable()) {
                    p.d("hibernateVer:" + string + ", current version:2.0.3");
                }
                long b = k.b(string);
    ...
    public static String getLocalMidOnly(Context context) {
        return context != null ? g.E(context).p().a() : "0";
    }
    ...
    public static void setSessionTimoutMillis(int i) {
        if (a(i, 1000, (int) TimeConstants.DAY)) {
            t = i;
        } else {
