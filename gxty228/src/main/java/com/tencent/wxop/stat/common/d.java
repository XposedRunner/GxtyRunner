...
class d {
    ...
    void a(JSONObject jSONObject, Thread thread) {
        if (thread == null) {
            ...
            if (k.c(this.r) && this.r.split(HttpUtils.PATHS_SEPARATOR).length == 2) {
                q.a(jSONObject, "fram", this.r.split(HttpUtils.PATHS_SEPARATOR)[0]);
            }
            if (k.c(this.s) && this.s.split(HttpUtils.PATHS_SEPARATOR).length == 2) {
                q.a(jSONObject, "from", this.s.split(HttpUtils.PATHS_SEPARATOR)[0]);
            }
            if (au.a(this.o).b(this.o) != null) {
                jSONObject.put("ui", au.a(this.o).b(this.o).b());
            }
            q.a(jSONObject, "mid", StatConfig.getLocalMidOnly(this.o));
        }
