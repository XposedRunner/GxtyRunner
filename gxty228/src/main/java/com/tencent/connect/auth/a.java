...
public class a extends Dialog {
            ...
            if (str.startsWith("auth://browser")) {
                ...
                if (!this.a.m) {
                    if (c.optString("fail_cb", null) != null) {
                        ...
                        a.a(this.a, this.a.a.indexOf(HttpUtils.URL_AND_PARA_SEPARATOR) > -1 ? HttpUtils.PARAMETERS_SEPARATOR : HttpUtils.URL_AND_PARA_SEPARATOR);
    ...
    static {
        try {
            ...
            } else if (new File(a.getFilesDir().toString() + HttpUtils.PATHS_SEPARATOR + AuthAgent.SECURE_LIB_NAME).exists()) {
                System.load(a.getFilesDir().toString() + HttpUtils.PATHS_SEPARATOR + AuthAgent.SECURE_LIB_NAME);
    ...
    private String a() {
        String str = "http://qzs.qq.com/open/mobile/login/qzsjump.html?" + this.a.substring(this.a.indexOf(HttpUtils.URL_AND_PARA_SEPARATOR) + 1);
    ...
    private boolean e() {
        ...
        this.a = substring + HttpUtils.URL_AND_PARA_SEPARATOR + com.tencent.open.utils.HttpUtils.encodeUrl(b);
