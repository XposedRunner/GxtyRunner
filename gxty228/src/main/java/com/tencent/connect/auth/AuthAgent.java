...
public class AuthAgent extends BaseApi {
    ...
    private class b implements IUiListener {
        ...
        protected void a() {
            ...
            Activity activity = (Activity) this.b.e.get();
            if (activity != null) {
                HttpUtils.requestAsync(this.b.b, activity, "http://appsupport.qq.com/cgi-bin/qzapps/mapp_addapp.cgi", g, Constants.HTTP_POST, null);
            }
        }
    ...
    private int a(boolean z, IUiListener iUiListener) {
        ...
        a.putString(WBConstants.AUTH_PARAMS_DISPLAY, "mobile");
        ...
        stringBuilder.append(com.tencent.open.utils.f.a().a(com.tencent.open.utils.d.a(), "http://openmobile.qq.com/oauth2.0/m_authorize?"));
            ...
            public void run() {
                ...
                if (activity != null) {
                    activity.runOnUiThread(new Runnable(this) {
                        ...
                        public void run() {
                            a aVar = new a(activity, "action_login", stringBuilder2, cVar, this.b.c.b);
                            if (activity != null && !activity.isFinishing()) {
                                aVar.show();
                            }
                        }
    ...
    protected void a(IUiListener iUiListener) {
        ...
        HttpUtils.requestAsync(this.b, com.tencent.open.utils.d.a(), "https://openmobile.qq.com/user/user_login_statis", a, Constants.HTTP_POST, null);
    ...
    protected void b(IUiListener iUiListener) {
        ...
        HttpUtils.requestAsync(this.b, com.tencent.open.utils.d.a(), "https://openmobile.qq.com/v3/user/get_info", a, Constants.HTTP_GET, tempRequestListener);
    }
}
