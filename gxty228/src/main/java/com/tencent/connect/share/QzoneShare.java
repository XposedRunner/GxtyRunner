    ...
    public void shareToQzone(final Activity activity, final Bundle bundle, final IUiListener iUiListener) {
        ...
        if (i.b() || !i.f(activity, "4.5.0")) {
            ...
            if (this.d) {
                ...
                if (!i.e(string3) && string3.length() > 200) {
                    bundle.putString("title", i.a(string3, 200, null, null));
                }
                if (!i.e(string2) && string2.length() > OtherError.CONTAINER_INVISIBLE_ERROR) {
                    bundle.putString("summary", i.a(string2, (int) OtherError.CONTAINER_INVISIBLE_ERROR, null, null));
                }
            }
            ...
            if (!i.f(activity, "4.6.0")) {
                ...
                a.a((Context) activity, stringArrayList, new c(this) {
                    ...
                    public void a(int i, ArrayList<String> arrayList) {
                        ...
                        this.d.b(activity, bundle, iUiListener);
                    }
                });
