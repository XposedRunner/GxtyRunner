...
public class NetworkClientImpl implements NetworkClient {
    ...
    static class TaskCallable implements Callable<Response> {
        ...
        private void a(HttpRequestBase httpRequestBase) {
            ...
            httpRequestBase.setHeader(HttpHeaders.HEAD_KEY_USER_AGENT, "GDTADNetClient-[" + System.getProperty("http.agent") + "]");
            httpRequestBase.addHeader(HttpHeaders.HEAD_KEY_ACCEPT_ENCODING, "gzip");
    ...
    public void submit(Request request, Priority priority, NetworkCallBack networkCallBack, Executor executor) {
        ...
        executor.execute(new NetFutureTask(this, new TaskCallable(request, networkCallBack), priority));
        GDTLogger.d("QueueSize:" + this.d.size());
    }
}
