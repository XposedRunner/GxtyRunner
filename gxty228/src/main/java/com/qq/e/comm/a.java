...
public class a {
    ...
    public static AdError a(int i) {
        switch (i) {
            ...
            case GLMapStaticValue.AM_PARAMETERNAME_NETWORK /*5001*/:
                return new AdError(GLMapStaticValue.AM_PARAMETERNAME_NETWORK, "服务端数据错误");
            case OtherError.CONTAINER_INVISIBLE_ERROR /*600*/:
            case 4004:
                return new AdError(4004, "开屏广告容器不可见");
            case OtherError.NETWORK_TYPE_ERROR /*601*/:
            case 3003:
                return new AdError(3003, "网络类型错误，当前设备的网络类型不符合开屏广告的加载条件");
            case OtherError.ANDROID_PERMMISON_ERROR /*602*/:
            case 4002:
                return new AdError(4002, "Manifest文件中Activity/Service/Permission的声明有问题");
            case OtherError.GET_PARAS_FROM_JS_ERROR /*603*/:
            case 200201:
                return new AdError(2002, "内部错误，详细码：200201");
            case OtherError.GET_PARAS_FROM_NATIVE_ERROR /*604*/:
            case 200202:
                return new AdError(2002, "内部错误，详细码：200202");
            case OtherError.CONTAINER_HEIGHT_ERROR /*606*/:
            case 4005:
                return new AdError(4005, "开屏广告容器的高度低于400dp");
            case OtherError.NATIVE_FORCE_EXPOSURE /*607*/:
            case 4006:
                return new AdError(4006, "原生广告接口调用顺序错误，调用点击接口前未调用曝光接口");
            case OtherError.SKIP_VIEW_SIZE_ERROR /*608*/:
            case 4009:
                return new AdError(4009, "开屏广告的自定义跳过按钮尺寸小于3x3dp");
            case OtherError.VIDEO_DOWNLOAD_ERROR /*700*/:
            case GLMapStaticValue.AM_PARAMETERNAME_MAX_RENDER_DURATION /*5002*/:
                return new AdError(GLMapStaticValue.AM_PARAMETERNAME_MAX_RENDER_DURATION, "视频素材下载错误");
            ...
            case GLMapStaticValue.AM_PARAMETERNAME_HALF_LEVEL_ZOOM /*4001*/:
                return new AdError(GLMapStaticValue.AM_PARAMETERNAME_HALF_LEVEL_ZOOM, "传入的参数有错误");
            case 4008:
            ...
            case 400101:
                return new AdError(GLMapStaticValue.AM_PARAMETERNAME_HALF_LEVEL_ZOOM, "传入的参数有错误，详细码：" + i);
            case 400102:
                return new AdError(GLMapStaticValue.AM_PARAMETERNAME_HALF_LEVEL_ZOOM, "传入的参数有错误，详细码：" + i);
            case 400103:
                return new AdError(GLMapStaticValue.AM_PARAMETERNAME_HALF_LEVEL_ZOOM, "传入的参数有错误，详细码：" + i);
    ...
    public static boolean a(Context context, File file, File file2) {
        ...
        try {
            ...
            StringUtil.writeTo("574#####" + PLUGIN.ASSET_PLUGIN_SIG, file2);
