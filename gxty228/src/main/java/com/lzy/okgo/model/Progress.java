...
public class Progress implements Serializable {
    ...
    public static Progress changeProgress(Progress progress, long j, long j2, a aVar) {
        ...
        if ((elapsedRealtime - progress.b >= com.lzy.okgo.a.a ? 1 : null) != null || progress.currentSize == j2) {
            long j3 = elapsedRealtime - progress.b;
            if (j3 == 0) {
                j3 = 1;
            }
            progress.fraction = (((float) progress.currentSize) * 1.0f) / ((float) j2);
            progress.speed = progress.a((progress.a * 1000) / j3);
            progress.b = elapsedRealtime;
            progress.a = 0;
            if (aVar != null) {
                aVar.a(progress);
            }
    ...
    private long a(long j) {
        ...
        for (Long longValue : this.c) {
            j2 = (long) (((float) longValue.longValue()) + ((float) j2));
        }
        return j2 / ((long) this.c.size());
    }
