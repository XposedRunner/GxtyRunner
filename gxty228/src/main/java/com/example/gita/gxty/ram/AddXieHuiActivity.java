...
public class AddXieHuiActivity extends BaseActivity {
    @BindView(2131755469)
    protected TextView countNum;
    @BindView(2131755471)
    protected TextView curNum;
    TXieHui f;
    @BindView(2131755467)
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.startTime.setText(this.f.open_time);
        this.curNum.setText(this.f.joined);
        this.countNum.setText(this.f.limited);
    }
    ...
    void butterknifeOnItemClick(View view) {
        if (R.id.actionBtn == view.getId()) {
            ...
            ((GetRequest) ((GetRequest) ((GetRequest) a.a(com.example.gita.gxty.a.a("association/doRexDataByUser")).tag(this)).params("sign", a.sign, new boolean[0])).params("data", a.data, new boolean[0])).execute(new com.example.gita.gxty.a.a<LzyResponse<String>>(this, this) {
                final /* synthetic */ AddXieHuiActivity a;
    ...
    protected int a() {
        return R.layout.activity_xiehui_detail;
    }
}
