...
import com.example.gita.gxty.adapter.ArticleAdapter;
...
public class ArticleFragment extends SearchBaseFragment implements RequestLoadMoreListener {
    ...
    public View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        this.g = layoutInflater.inflate(R.layout.frag_article, null);
        return this.g;
    }
    ...
    private void d() {
        this.e = new ArticleAdapter(new ArrayList());
        ...
        this.e.setOnItemClickListener(new OnItemClickListener(this) {
            ...
            public void onItemClick(BaseQuickAdapter baseQuickAdapter, View view, int i) {
                ...
                intent.putExtra("isHuodong", false);
