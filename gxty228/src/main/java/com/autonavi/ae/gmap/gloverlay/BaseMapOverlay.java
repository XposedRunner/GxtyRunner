...
public abstract class BaseMapOverlay<T extends GLOverlay, E> implements Serializable {
    ...
    public BaseMapOverlay(int i, Context context, lj ljVar) {
        this.mEngineID = i;
    ...
    public final E getItem(int r4) {
        ...
        r3 = this;
        r1 = 0;
        r2 = r3.mItemList;	 Catch:{ IndexOutOfBoundsException -> 0x001e }
        monitor-enter(r2);	 Catch:{ IndexOutOfBoundsException -> 0x001e }
        if (r4 < 0) goto L_0x0010;
    L_0x0006:
        r0 = r3.mItemList;	 Catch:{ all -> 0x001b }
    ...
    L_0x001e:
        ...
        goto L_0x0012;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.autonavi.ae.gmap.gloverlay.BaseMapOverlay.getItem(int):E");
    }
