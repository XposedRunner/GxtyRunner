...
import com.amap.api.mapcore.util.lc;
...
public class Inner_3dMap_location extends Location implements Cloneable {
    ...
    public String getErrorInfo() {
        ...
        if (this.errorCode != 0) {
            ...
            stringBuilder.append(",错误详细信息:" + this.locationDetail);
        }
        ...
        try {
            ...
            switch (i) {
                case 1:
                    ...
                    jSONObject.put(ParamKey.POINAME, this.poiName);
                    ...
                    jSONObject.put(ParamKey.POIID, this.buildingId);
    ...
    public String toStr(int i) {
        ...
        try {
            ...
            kz.a(th, "AMapLocation", "toStr part2");
            toJson = null;
        }
