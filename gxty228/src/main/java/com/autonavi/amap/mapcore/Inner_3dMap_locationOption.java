...
public class Inner_3dMap_locationOption implements Cloneable {
    ...
    private long httpTimeOut = ((long) kz.f);
    ...
    public String toString() {
        ...
        stringBuilder.append("interval:").append(String.valueOf(this.interval)).append("#");
        stringBuilder.append("isOnceLocation:").append(String.valueOf(this.isOnceLocation)).append("#");
        stringBuilder.append("locationMode:").append(String.valueOf(this.locationMode)).append("#");
        stringBuilder.append("isMockEnable:").append(String.valueOf(this.isMockEnable)).append("#");
        stringBuilder.append("isKillProcess:").append(String.valueOf(this.isKillProcess)).append("#");
        stringBuilder.append("isGpsFirst:").append(String.valueOf(this.isGpsFirst)).append("#");
        stringBuilder.append("isNeedAddress:").append(String.valueOf(this.isNeedAddress)).append("#");
        stringBuilder.append("isWifiActiveScan:").append(String.valueOf(this.isWifiActiveScan)).append("#");
        stringBuilder.append("httpTimeOut:").append(String.valueOf(this.httpTimeOut)).append("#");
        stringBuilder.append("isOffset:").append(String.valueOf(this.isOffset)).append("#");
        stringBuilder.append("isLocationCacheEnable:").append(String.valueOf(this.isLocationCacheEnable)).append("#");
        stringBuilder.append("isLocationCacheEnable:").append(String.valueOf(this.isLocationCacheEnable)).append("#");
        stringBuilder.append("isOnceLocationLatest:").append(String.valueOf(this.isOnceLocationLatest)).append("#");
        stringBuilder.append("sensorEnable:").append(String.valueOf(this.sensorEnable)).append("#");
