...
public final class RegexUtils {
    ...
    public static boolean isIDCard18Exact(CharSequence charSequence) {
        ...
        if (CITY_MAP.isEmpty()) {
            CITY_MAP.put(Constants.VIA_REPORT_TYPE_SHARE_TO_QZONE, "北京");
            CITY_MAP.put(Constants.VIA_REPORT_TYPE_SET_AVATAR, "天津");
            CITY_MAP.put(Constants.VIA_REPORT_TYPE_JOININ_GROUP, "河北");
            CITY_MAP.put(Constants.VIA_REPORT_TYPE_MAKE_FRIEND, "山西");
            CITY_MAP.put(Constants.VIA_REPORT_TYPE_WPA_STATE, "内蒙古");
            CITY_MAP.put(Constants.VIA_REPORT_TYPE_QQFAVORITES, "辽宁");
            CITY_MAP.put(Constants.VIA_REPORT_TYPE_DATALINE, "吉林");
            CITY_MAP.put(Constants.VIA_REPORT_TYPE_SHARE_TO_TROOPBAR, "黑龙江");
            CITY_MAP.put("31", "上海");
            CITY_MAP.put("32", "江苏");
            CITY_MAP.put("33", "浙江");
            CITY_MAP.put("34", "安徽");
        ...
        for (int i2 = 0; i2 < 17; i2++) {
            i += (charSequence.charAt(i2) - 48) * iArr[i2];
        }
