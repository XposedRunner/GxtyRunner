...
public class a implements b {
    ...
    L_0x002a:
        ...
        r0[r1] = r6;
        com.nostra13.universalimageloader.b.c.c(r2, r0);
        goto L_0x0017;
        */
    ...
    protected Options a(c cVar, c cVar2) {
        ...
        if (d == ImageScaleType.NONE) {
            ...
            i = com.nostra13.universalimageloader.b.a.a(cVar);
        } else {
            boolean z;
            c c = cVar2.c();
            ...
            i = com.nostra13.universalimageloader.b.a.a(cVar, c, cVar2.e(), z);
        }
        if (i > 1 && this.a) {
            com.nostra13.universalimageloader.b.c.a("Subsample original image (%1$s) to %2$s (scale = %3$d) [%4$s]", cVar, cVar.a(i), Integer.valueOf(i), cVar2.a());
        }
        Options i2 = cVar2.i();
        i2.inSampleSize = i;
        return i2;
    ...
    protected Bitmap a(Bitmap bitmap, c cVar, int i, boolean z) {
        ...
        if (d == ImageScaleType.EXACTLY || d == ImageScaleType.EXACTLY_STRETCHED) {
            float b = com.nostra13.universalimageloader.b.a.b(new c(bitmap.getWidth(), bitmap.getHeight(), i), cVar.c(), cVar.e(), d == ImageScaleType.EXACTLY_STRETCHED);
            if (Float.compare(b, 1.0f) != 0) {
                matrix.setScale(b, b);
                if (this.a) {
                    com.nostra13.universalimageloader.b.c.a("Scale subsampled image (%1$s) to %2$s (scale = %3$.5f) [%4$s]", r2, r2.a(b), Float.valueOf(b), cVar.a());
                }
            }
        }
        if (z) {
