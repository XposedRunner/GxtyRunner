...
public class eq extends er {
    ...
    public eq(Context context, int i, int i2) {
        super(context);
        a(i, i2);
    }
    ...
    public static Bitmap a(Resources resources, int i, int i2, int i3, es esVar) {
    ...
    public static Bitmap a(FileDescriptor fileDescriptor, int i, int i2, es esVar) {
        Options options = new Options();
        options.inJustDecodeBounds = true;
