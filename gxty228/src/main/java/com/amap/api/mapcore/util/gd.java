...
public class gd {
    ...
    public static String a(Context context) {
        try {
            ...
            gk a = gu.a();
            if (hn.a(context, a)) {
                Class a2 = hn.a(context, a, gl.c("WY29tLmFtYXAuYXBpLmFpdW5ldC5OZXRSZXVlc3RQYXJhbQ"));
                if (a2 != null) {
    ...
    public static String b(final Context context) {
        try {
            ...
            if (hn.a(context, a)) {
                final Class a2 = hn.a(context, a, gl.c("WY29tLmFtYXAuYXBpLmFpdW5ldC5OZXRSZXVlc3RQYXJhbQ"));
                if (a2 == null) {
                    return b;
                }
                    ...
                    gz.d().submit(new Runnable() {
                        public void run() {
                            try {
                                ...
                                if (map != null) {
                                    String str = (String) a2.getMethod("getPostParam", new Class[]{String.class, String.class, String.class, String.class}).invoke(a2, new Object[]{gd.h(context), gd.u(context), gd.l(context), gd.v(context)});
                                    if (!TextUtils.isEmpty(str)) {
                                        byte[] a = it.a().a(new is(str.getBytes(), map));
    ...
    private static String x(Context context) {
        ...
        try {
            if (gl.a(context, "android.permission.READ_EXTERNAL_STORAGE") && "mounted".equals(Environment.getExternalStorageState())) {
    ...
    public static String c() {
        ...
        try {
            if (VERSION.SDK_INT >= 26) {
                return (String) gl.a(Build.class, "MZ2V0U2VyaWFs", new Class[0]).invoke(Build.class, new Object[0]);
            }
    ...
    public static String i(Context context) {
        ...
        try {
            k = Secure.getString(context.getContentResolver(), gl.c(new String(gu.a(13))));
            return k == null ? "" : k;
        } catch (Throwable th) {
            return k;
        }
    ...
    static String j(Context context) {
        ...
        try {
            if (!a(context, gl.c("WYW5kcm9pZC5wZXJtaXNzaW9uLkFDQ0VTU19XSUZJX1NUQVRF"))) {
                return str;
            }
    ...
    public static String l(Context context) {
        try {
            ...
            if (gl.c("YMDI6MDA6MDA6MDA6MDA6MDA").equals(m) || gl.c("YMDA6MDA6MDA6MDA6MDA6MDA").equals(m)) {
                m = d();
            }
            return m;
        } catch (Throwable th) {
    ...
    static String[] m(Context context) {
        try {
            if (a(context, gl.c("WYW5kcm9pZC5wZXJtaXNzaW9uLlJFQURfUEhPTkVfU1RBVEU=")) && a(context, gl.c("EYW5kcm9pZC5wZXJtaXNzaW9uLkFDQ0VTU19DT0FSU0VfTE9DQVRJT04="))) {
    ...
    static String n(Context context) {
        String str = "";
        try {
            if (!a(context, gl.c("WYW5kcm9pZC5wZXJtaXNzaW9uLlJFQURfUEhPTkVfU1RBVEU="))) {
                return str;
            }
    ...
    public static NetworkInfo r(Context context) {
        if (!a(context, gl.c("AYW5kcm9pZC5wZXJtaXNzaW9uLkFDQ0VTU19ORVRXT1JLX1NUQVRF"))) {
            return null;
        }
    ...
    public static String u(Context context) {
        try {
            ...
            Method a = gl.a(E.getClass(), "QZ2V0RGV2aWNlSWQ", new Class[0]);
            if (a != null) {
                o = (String) a.invoke(E, new Object[0]);
            }
            if (o == null) {
                o = "";
            }
    ...
    private static String y(Context context) throws InvocationTargetException, IllegalAccessException {
        ...
        Method a = gl.a(E.getClass(), "UZ2V0U3Vic2NyaWJlcklk", new Class[0]);
        if (a != null) {
            q = (String) a.invoke(E, new Object[0]);
        }
        if (q == null) {
            q = "";
        }
    ...
    private static int A(Context context) {
        if (context == null || !a(context, gl.c("AYW5kcm9pZC5wZXJtaXNzaW9uLkFDQ0VTU19ORVRXT1JLX1NUQVRF"))) {
            return -1;
        }
        ConnectivityManager B = B(context);
        if (B == null) {
