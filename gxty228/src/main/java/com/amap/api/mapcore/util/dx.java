...
public class dx<K, V> {
    ...
    L_0x0056:
        ...
        goto L_0x001a;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore.util.dx.a(java.lang.Object):V");
    }
    ...
    private void a(int i) {
        while (true) {
            ...
            Object value;
            synchronized (this) {
                boolean z = this.b < 0 || (this.a.isEmpty() && this.b != 0);
                if (z) {
                }
                if (this.b <= i) {
                    return;
