...
public class TextureMapFragment extends Fragment {
    ...
    protected IMapFragmentDelegate getMapFragmentDelegate() {
        if (this.b == null) {
            try {
                this.b = (IMapFragmentDelegate) hn.a(getActivity(), en.e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", lo.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(1)});
            } catch (Throwable th) {
            }
            if (this.b == null) {
                this.b = new lo(1);
