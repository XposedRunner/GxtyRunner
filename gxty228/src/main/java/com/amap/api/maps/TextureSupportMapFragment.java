    ...
    protected IMapFragmentDelegate getMapFragmentDelegate(Context context) {
        if (this.b == null) {
            try {
                ...
                this.b = (IMapFragmentDelegate) hn.a(context2, en.e(), "com.amap.api.wrapper.MapFragmentDelegateWrapper", lo.class, new Class[]{Integer.TYPE}, new Object[]{Integer.valueOf(1)});
            } catch (Throwable th) {
            }
            if (this.b == null) {
                this.b = new lo(1);
