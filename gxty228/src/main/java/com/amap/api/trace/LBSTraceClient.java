...
public class LBSTraceClient {
    ...
    private static void a(Context context) {
        if (context != null) {
            try {
                a = (LBSTraceBase) hn.a(context.getApplicationContext(), en.e(), "com.amap.api.wrapper.LBSTraceClientWrapper", fn.class, new Class[]{Context.class}, new Object[]{context.getApplicationContext()});
            } catch (Throwable th) {
