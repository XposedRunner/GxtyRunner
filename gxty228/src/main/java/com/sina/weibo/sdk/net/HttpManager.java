    ...
    private static HttpResponse requestHttpExecute(Context context, String str, String str2, WeiboParameters weiboParameters) {
        ...
        try {
            ...
            try {
                ...
                if (str2.equals("GET")) {
                    String stringBuilder = new StringBuilder(String.valueOf(str)).append(HttpUtils.URL_AND_PARA_SEPARATOR).append(weiboParameters.encodeUrl()).toString();
                    ...
                    try {
                        ...
                        if (weiboParameters.hasBinaryData()) {
                            httpPost.setHeader(HttpHeaders.HEAD_KEY_CONTENT_TYPE, "multipart/form-data; boundary=" + BOUNDARY);
                            ...
                            if (obj == null || !(obj instanceof String)) {
                                ...
                                httpPost.setHeader(HttpHeaders.HEAD_KEY_CONTENT_TYPE, (String) obj);
                            }
        ...
        try {
            ...
            try {
                ...
                if (statusCode == 301 || statusCode == 302) {
                    value = execute.getFirstHeader(HttpHeaders.HEAD_KEY_LOCATION).getValue();
    ...
    public static String openRedirectUrl4LocationUri(Context context, String str, String str2, WeiboParameters weiboParameters) {
        ...
        try {
            ...
            try {
                ...
                defaultHttpClient.getParams().setParameter("http.route.default-proxy", NetStateManager.getAPN());
                if (str2.equals("GET")) {
                    httpGet = new HttpGet(new StringBuilder(String.valueOf(str)).append(HttpUtils.URL_AND_PARA_SEPARATOR).append(weiboParameters.encodeUrl()).toString());
                } else if (str2.equals("POST")) {
                    httpGet = new HttpPost(str);
                }
                httpGet.setHeader(HttpHeaders.HEAD_KEY_USER_AGENT, NetworkHelper.generateUA(context));
        ...
        synchronized (HttpManager.class) {
            ...
            if (file2.exists()) {
                ...
                try {
                    ...
                    HttpResponse execute = newHttpClient.execute(httpGet);
                    int statusCode = execute.getStatusLine().getStatusCode();
                    if (statusCode == TinkerReport.KEY_APPLIED_FAIL_COST_10S_LESS) {
                        Header[] headers = execute.getHeaders(HttpHeaders.HEAD_KEY_CONTENT_RANGE);
                        ...
                        j = 0;
                        Header firstHeader = execute.getFirstHeader(HttpHeaders.HEAD_KEY_CONTENT_LENGTH);
                        if (firstHeader != null) {
                    ...
                    Header firstHeader2 = execute.getFirstHeader(HttpHeaders.HEAD_KEY_CONTENT_ENCODING);
